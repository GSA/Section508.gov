...
document.addEventListener('DOMContentLoaded', function () {
    let header = `{% endraw %}{% include header_banner.html %} <div class="usa-overlay"></div> {% include menu.html primary_navigation=site.primary_navigation  secondary_navigation=site.secondary_navigation %}{% if site.data.alert.display == true %}{% include header_alert.html %}{% endif %}{% raw %}`;
