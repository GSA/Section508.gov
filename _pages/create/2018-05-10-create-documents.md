...
<div class="grid-row grid-gap">
    <div class="desktop:grid-col-3 display-flex flex-column flex-align-self-center">
      <a href="{{site.baseurl}}/create/documents/training-videos"><img  alt="How to Test and Remediate PDFs for Accessibility Using Adobe Acrobat DC"  src="https://assets.section508.gov/files/thumbnails/training-video-word-thumb.png" style="width:100%" class="radius-lg" /></a>
    </div>
