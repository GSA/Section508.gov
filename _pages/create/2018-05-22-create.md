...
<ul class="usa-card-group">
    ...
    <div class="usa-card__container">
      ...
      <div class="usa-card__media">
        <div class="usa-card__img">
          <img src="https://assets.section508.gov/files/images/thumb-create-doc.jpg" alt="" aria-hidden="true"/>
        </div>
      </div>
  ...
  <li class="usa-card tablet:grid-col-4 widescreen:grid-col-4">
    <div class="usa-card__container">
      ...
      <div class="usa-card__media">
        <div class="usa-card__img">
          <img src="https://assets.section508.gov/files/images/thumb-create-slide.jpg" alt="" aria-hidden="true"/>
        </div>
      </div>
      <div class="usa-card__body">
  ...
  <li class="usa-card tablet:grid-col-4 widescreen:grid-col-4">
    <div class="usa-card__container">
      ...
      <div class="usa-card__media">
        <div class="usa-card__img">
          <img src="https://assets.section508.gov/files/images/thumb-create-sheet.jpg" alt="" aria-hidden="true"/>
        </div>
      </div>
      <div class="usa-card__body">
