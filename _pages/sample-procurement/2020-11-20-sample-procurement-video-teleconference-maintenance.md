...
The Accessibility Requirements Report should be incorporated into the solicitation requirements document (SOO, SOW, PWS, etc.). Please go to the Revised 508 Standards Toolkit [(https://section508.gov/manage/program-roadmap)][7] for further information on the procurement process.
 ...
 [7]: https://section508.gov/manage/program-roadmap