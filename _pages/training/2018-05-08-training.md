...
<div class="grid-row grid-gap">
  <div class="desktop:grid-col-3 display-flex flex-column flex-align-self-center">
    <a href="{{site.baseurl}}/create/pdfs/training-videos"><img alt="How to Test and Remediate PDFs for Accessibility Using Adobe Acrobat DC" src="https://assets.section508.gov/assets/images/thumbnails/training-video-pdf-series.jpg" style="width:100%; border: 1px black solid;" class="radius-lg" class="radius-lg" /></a>
  </div>
  <div class="desktop:grid-col-9">
