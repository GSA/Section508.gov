...
<div style="width: 100%; border: 1px solid black; background-color: #f5f9fc;" class="border-base radius-lg padding-1 margin-top-5">
  ...
  <ul>
    ...
    <li><a href="{{site.baseurl}}/training/online-course/procuring-section-508-conformant-ict/">Course ID: FAC 049 | Section 508: What Is It and Why Is It Important?</a></li>
...
<div class="grid-row grid-gap">
  <div class="desktop:grid-col-3 display-flex flex-column flex-align-self-center">
    <a href="{{site.baseurl}}/test/web-software/andi-training-videos"><img src="https://assets.section508.gov/files/thumbnails/training-video-andi-00-thumb.jpg" alt="Accessible Name & Description Inspector (ANDI) Tool Overview" style="width:100%" /></a>
  </div>
  <div class="desktop:grid-col-9">
...
<div class="grid-row grid-gap">
  <div class="desktop:grid-col-3 display-flex flex-column flex-align-self-center">
    <a href="{{site.baseurl}}/test/web-software/andi-training-videos/color-contrast-analyzer"><img src="https://assets.section508.gov/files/thumbnails/training-video-andi-14-thumb.jpg" alt="How to Test Color Contrast using the Color Contrast Analyser" style="width:100%" /></a>
  </div>
  <div class="desktop:grid-col-9">
