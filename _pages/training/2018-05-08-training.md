...
<div class="grid-row grid-gap">
  <div class="desktop:grid-col-3 display-flex flex-column flex-align-self-center">
    <a href="{{site.baseurl}}/test/web-software/andi-training-videos"><img src="https://training.section508.gov/assets/videos/training-video-andi-00.jpg" alt="Accessible Name & Description Inspector (ANDI) Tool Overview" style="width:100%" /></a>
  </div>
  <div class="desktop:grid-col-9">
...
<div class="grid-row grid-gap">
  <div class="desktop:grid-col-3 display-flex flex-column flex-align-self-center">
    <a href="{{site.baseurl}}/test/web-software/andi-training-videos/color-contrast-analyzer"><img src="https://training.section508.gov/assets/videos/training-video-andi-14.jpg" alt="How to Test Color Contrast using the Color Contrast Analyser" style="width:100%" /></a>
  </div>
  <div class="desktop:grid-col-9">
