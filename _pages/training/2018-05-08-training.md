...
<div style="width: 100%; border: 1px solid black; background-color: #f5f9fc;" class="border-base radius-lg padding-1 margin-top-5">
  ...
  <ul>
    <li><a href="{{base.siteurl}}/training/online-course/micro-purchases/" target="_blank" class="usa-link--external">Course ID: FAC 047 | Micro-Purchases and Section 508 Requirements</a></li>
    <li><a href="{{site.baseurl}}/training/online-course/procuring-section-508-conformant-ict/" target="_blank" class="usa-link--external">Course ID: FAC 049 | Section 508: What It Is and Why It's Important?</a></li>
    <li><a href="{{site.baseurl}}/training/online-course/procuring-section-508-conformant-ict/" target="_blank" class="usa-link--external">Course ID: FAC 056 | Procuring Section 508 Conformant ICT Products and Services</a></li>
  </ul>
...
<ul>
  <li><a href="https://assets.section508.gov/files/Digital%20Dashboard%20Accessibility%20Module%20Webinar.pptx">Digital Dashboard Accessibility Module Webinar (PPTX)</a> - Overview of the purpose, uses, and function of the Digital Dashboard Accessibility module</li>
  <li><a href="https://assets.section508.gov/files/Trusted%20Tester%20Awareness%20Webinar.pptx">Trusted Tester Awareness Webinar (PPTX)</a> - Overview of the purpose, benefits, and components of the Trusted Tester certification program</li>
