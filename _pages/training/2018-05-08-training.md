...
<div class="desktop:grid-col-9">
  ...
  <div class="grid-row grid-gap">
    ...
    <div class="desktop:grid-col-9">
      ...
      <p>This video provides a demonstration of how you can use the Accessibility Requirements Tool (ART). ART allows you to generate a list of Section 508 requirements that apply to the Information Communication Technology (ICT) that you wish to procure. This video explains when you should use ART, how to create and edit your list using ART, and how to use the list that gets generated.</p>
