...
<span id="evaluating-acrs"></span>
  * **<a href="https://training.section508.gov/508-training/courses/soliciting-and-evaluating-acrs/index.html" target="_blank" aria-label="certificate of completion">Soliciting and Evaluating Accessibility Conformance Reports in Federal ICT Procurement</a>:** This training covers how to identify when you need to create or request an Accessibility Conformance Report (ACR) for an Information and Communication Technology (ICT) product or service. It also covers the steps to take to write an ACR, and how to evaluate an ACR for a product. This training is intended both for those in the federal government who procure ICT and for vendors who provide ICT for federal government contracts.  
    **Audience**: Government Purchase Card holders, Contracting Officers, Contracting Officer’s Representatives (COR), Requiring Officials, Approving Officials  
    **Course length**: 1 hour  
    **Certificate or CLPs available?**: _Certificate of Completion_
