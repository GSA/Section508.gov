    ...
    <div class="usa-card__container">
      ...
      <div class="usa-card__media usa-card__media--inset">
        <div class="usa-card__img">
          <img src="{{site.baseurl}}/assets/images/thumbnails/online-course-thumbnail-micro-purchases.jpg" alt="" class="radius-lg" />
        </div>
      </div>
      ...
      <div class="usa-card__footer">
        <a href="https://assets.section508.gov/assets/online-training/micro-purchases-and-section-508-requirements/lesson1/index.html" target="_blank" class="usa-button">Open Course</a>&nbsp;<a href="https://www.fai.gov/training/find-and-register-for-courses" target="_blank" class="usa-button usa-button--accent-warm">Earn CLPs via FAC 047</a>
      </div>
    </div>
  </li>
</ul>
