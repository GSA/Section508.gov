...
description: 
permalink: training/online-course/microsoft-word-accessibility-for-document-designers/
  ...
  <li class="usa-card usa-card--flag flex-1 usa-card--media-right">
    <div class="usa-card__container">
      ...
      <div class="usa-card__media usa-card__media--inset">
        <div class="usa-card__img fixed-thumb">
          <img src="{{site.baseurl}}/assets/images/android-chrome-192x192" alt="" class="radius-lg" />
        </div>
      </div>
...
<ol class="usa-icon-list tablet:grid-col">
    <li class="usa-icon-list__item">
        ...
        <div class="usa-icon-list__content">lorem ipsum.</div>
    </li>
    <li class="usa-icon-list__item">
        <div class="usa-icon-list__icon text-green"><svg class="usa-icon" aria-hidden="true" role="img"><use xlink:href="{{ site.baseurl }}/assets/images/sprite.svg#check_circle"></use></svg></div>
        <div class="usa-icon-list__content">lorem ipsum.</div>
  ...
  <div id="change-log" class="usa-accordion__content usa-prose">
    <ul>
      <li class="usa-icon-list__item">
        ...
        <div class="usa-icon-list__content"><strong>December 2025 - v1.0 | Release:</strong> Initial release of the course with core lessons, practice quizzes, and foundational learning.</div>
      </li>
    </ul>
  </div>
</div>
