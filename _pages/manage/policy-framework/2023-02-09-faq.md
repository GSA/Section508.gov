...
description: "The IT Accessibility Policy Framework is a tool created by the Government-wide IT Accessibility Team from the General Services Administration (GSA)."
type: manage
...
<ol id="faq-list">
  ...
  <p>
  After determining which policies are relevant to digital accessibility, evaluate  each policy for <b>Importance</b> and <b>Sufficiency</b>. We recommend using the downloadable <a href="https://www.section508.gov/~assets/files/policy%2Breview%2Btemplate.xlsx" target="_blank" class="usa-link--external">Policy Review Template (XLSX)</a>.
  </p>
  </li>
