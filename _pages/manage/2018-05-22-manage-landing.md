  ...
  <li class="usa-card mobile:grid-col-12 tablet:grid-col-6 desktop:grid-col-4">
    <div class="usa-card__container">
      <header class="usa-card__header">
        <h2 class="usa-card__heading font-family-sans"><a href="{{site.baseurl}}/manage/laws-and-policies/">ICT Accessibility Laws & Policies</a></h2>
      </header>
      <div class="usa-card__media">
        <div class="usa-card__img bg-blue">
          <img src="{{site.baseurl}}/assets/images/thumbnails/thumb-manage-law-col3.png" alt="" aria-hidden="true"/>
        </div>
      </div>
      <div class="usa-card__body">
        <p>Learn the laws and policies that govern how ICT products and digital services are acquired, developed, used, and maintained.</p>
    ...
    <div class="usa-card__container">
      ...
      <div class="usa-card__media">
        <div class="usa-card__img bg-red">
          <img src="{{site.baseurl}}/assets/images/thumbnails/thumb-manage-program-col3.png" alt="" aria-hidden="true"/>
        </div>
      </div>
      <div class="usa-card__body">
    ...
    <div class="usa-card__container">
      ...
      <div class="usa-card__media">
        <div class="usa-card__img bg-gold">
          <img src="{{site.baseurl}}/assets/images/thumbnails/thumb-manage-assessment-col3.png" alt="" aria-hidden="true"/>
        </div>
      </div>
      <div class="usa-card__body">
        ...
        <ul class="add-list-reset">     
          ...
          <li><a href="{{site.baseurl}}/manage/agency-508-reporting-requirements/">Reporting for Federal Agencies</a></li>
        </ul>
      </div>
    </div>
  </li>
    ...
    <div class="usa-card__container">
      ...
      <div class="usa-card__media">
        <div class="usa-card__img bg-primary-light">
          <img src="{{site.baseurl}}/assets/images/thumbnails/thumb-manage-community-col3.png" alt="" aria-hidden="true"/>
        </div>
      </div>
      <div class="usa-card__body">
