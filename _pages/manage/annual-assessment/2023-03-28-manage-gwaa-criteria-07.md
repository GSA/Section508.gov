...
<p>This section asks about your reporting entity's level of inclusion of accessibility in the technology lifecycle to include design, development, operation, and maintenance of ICT. If your reporting entity does not have a formal technology lifecycle process, please select N/A as needed.</p>
...
{% for each in site.data.gwaa_criteria_understanding %}
    {% if each.dimension == "lifecycle" %} {% comment %}Dimensions: general, program, policies, communications, content, hr, lifecycle, testing, acquisition, training, conformance{% endcomment %}
