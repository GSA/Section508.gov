...
{% for each in site.data.gwaa_criteria_understanding %}
    {% if each.dimension == "policies" %} {% comment %}Dimensions: general, program, policies, communications, content, hr, lifecycle, testing, acquisition, training, conformance{% endcomment %}
