...
{% for each in site.data.gwaa_criteria_understanding %}
    {% if each.dimension == "testing" %} {% comment %}Dimensions: general, program, policies, communications, content, hr, lifecycle, testing, acquisition, training, conformance{% endcomment %}
