...
<table id="table-12" class="usa-table usa-table--borderless striped grid-col-12 margin-bottom-3">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">Contracting Officer’s Technical Representative (COTR) or Contracting Officer’s Representative (COR)</th>
...
<div class="tablet:grid-col" style="margin: auto; max-width: 90%; text-align: center; padding: 10px 0px">
   <div class="margin-top-1"><img src="https://assets.section508.gov/assets/images/assessment/fy24/figure-22.jpg" alt="A bar chart showing the total number of authorized Undue Burden Exceptions in FY23 was 20 compared to 8 in FY24." aria-describedby="figure-22" class="border-2px border-base-light shadow-2 padding-1">
   </div>
...
<div class="tablet:grid-col" style="margin: auto; max-width: 90%; text-align: center; padding: 10px 0px">
   <div class="margin-top-1"><img src="https://assets.section508.gov/assets/images/assessment/fy24/figure-23.jpg" alt="A bar chart showing the total number of authorized Best Meets Exceptions in FY23 was 2774 compared to 1944 in FY24." aria-describedby="figure-23" class="border-2px border-base-light shadow-2 padding-1">
   </div>
   </div>
