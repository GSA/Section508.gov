...
sidenav: true
type: report2025
title: "Appendix A: Methods"
permalink: manage/section-508-assessment/2025/appendix-a/
description: The FY 2025 Governmentwide Section 508 Assessment, prepared by the General Services Administration, establishes a new benchmark for ICT accessibility across federal agencies, reflecting significant updates to evaluation standards and methods. Data were self-reported by agencies, parent agencies, and components, with no independent validation applied.
topic: "Law (law)"
sub-topic: "Reporting"
audience:
...
Comprehensive submission data by agency, parent agency, and component can be found at [Section508.gov under Assessment & Data Downloads]({{site.baseurl}}/manage/section-508-assessment/2025/assessment-data-downloads/). In addition, a supplemental data dictionary details the assessment criteria, answer selections by criteria, dependencies, “understanding” content and variable identifiers.
...
<table id="table-a2" class="usa-table usa-table--borderless usa-table--striped">
...
<table id="table-a3" class="usa-table usa-table--borderless usa-table--striped">
...
<table id="table-a4" class="usa-table usa-table--borderless usa-table--striped">
