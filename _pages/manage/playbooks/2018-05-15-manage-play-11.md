            ...
            <ul>
              ...
              <li>Review the agency&#39;s Section 504 policies.
                <div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
                  <strong>Note:</strong> Reasonable accommodations may be appropriate even when ICT meets Section 508 Standards.
                </div>
              </li>
            </ul>
          </td>
...
<div id="accordion-group-kpi" class="usa-accordion usa-accordion--multiselectable usa-accordion--bordered" data-allow-multiple>
  <h3 class="usa-accordion__heading">
    <button id="kpi-" type="button" class="usa-accordion__button" aria-expanded="true" aria-controls="m-b1"
  ...
  <h3 class="usa-accordion__heading">
    <button id="kpi-" type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="m-b2"
  ...
  <h3 class="usa-accordion__heading">
    <button id="kpi-" type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="m-b3"
  ...
  <h3 class="usa-accordion__heading">
    <button id="kpi-" type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="m-b4"
  ...
  <h3 class="usa-accordion__heading">
    <button id="kpi-" type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="m-b5"
  ...
  <h3 class="usa-accordion__heading">
    <button id="kpi-" type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="m-b7"
  ...
  <h3 class="usa-accordion__heading">
    <button id="kpi-" type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="m-b8"
  ...
  <h3 class="usa-accordion__heading">
    <button id="kpi-" type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="m-b9"
  ...
  <h3 class="usa-accordion__heading">
    <button id="kpi-" type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="m-b10"
  ...
  <h3 class="usa-accordion__heading">
    <button id="kpi-" type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="m-b11"
  ...
  <h3 class="usa-accordion__heading">
    <button id="kpi-" type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="m-b12"
  ...
  <h3 class="usa-accordion__heading">
    <button id="kpi-" type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="m-b13"
  ...
  <h3 class="usa-accordion__heading">
    <button id="kpi-" type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="m-b14"
  ...
  <h3 class="usa-accordion__heading">
    <button id="kpi-" type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="m-b15"
  ...
  <h3 class="usa-accordion__heading">
    <button id="kpi-" type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="m-b16"
