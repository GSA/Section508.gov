      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Develop a process to assess and troubleshoot the issue:
            <ul>
              ...
              <li>Is the problem caused by non-conformance with the <a href="https://www.access-board.gov/ict/">Section 508 Standards</a>?</li>
            </ul>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>Develop and implement a process for managing Section 508-related complaints.
            <ul>
              <li>Utilize <a href="https://www.section508.gov/manage/laws-and-policies/Section-508-complaints-best-practices/">best practices to create a repeatable Section 508 complaints process</a> which can be based on your agency&#39;s Section 504 Complaint Policy.</li>
              ...
              <li>Review the agency&#39;s Section 504 policies. Note: Reasonable accommodations may be appropriate even when ICT meets Section 508 Standards.</li>
            </ul>
          </td>
        </tr>
      </tbody>
...
<div id="checklist-quick-links" class="itad-card-group margin-bottom-5">
  ...
  <div class="itad-card__body">
    ...
    <ul>
      <li>Glossary term: <a href="{{site.baseurl}}/tools/glossary/#grc">Governance, Risk, and Compliance (GRC) Tools</a></li>
      ...
      <li><a href="">Essential Elements of a Test Report</a>&mdash;NEED LINK</li>
