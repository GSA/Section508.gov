...
permalink: manage/playbooks/technology-accessibility-playbook/05/
redirect_from:
...
<section class="padding-bottom-2">
  <ul class="usa-icon-list">
    ...
    <li class="usa-icon-list__item">
      ...
      <div class="usa-icon-list__content">Do agency technology teams engage your Section 508 Program team to provide accessibility expertise? How do you communicate across the agency that this accessibility/508 resource exists and what services it provides?</div>
    </li>
  </ul>
</section>
    ...
    <table id="10-1-0" class="usa-table usa-table--borderless striped grid-col-desktop">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Team members should have experience with:
            <ul>
              ...
              <li>Evaluating, testing, and validating technology for Section 508 conformance, such as <A href="{{site.baseurl}}/test/trusted-tester/">DHS Trusted Tester certification</a></li>
        ...
        <tr>
          ...
          <td>Similar to the <a href="{{site.baseurl}}/manage/program-manager-responsibilities/">Section 508 Program Manager skills</a>, team members should have in-depth knowledge of:
            <ul>
...
<div id="prev-next-section">
    <a class="prev-page" title="Go to Play 4" 
      href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook/04"> < Play 4</a>
    <a class="prev-page" title="Go to Play 6"
      href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook/06"> 
      Play 6 >
    </a>
</div>
