...
<section class="padding-bottom-2">
  <ul class="usa-icon-list maxw-full">
    ...
    <li class="usa-icon-list__item">
      ...
      <div class="usa-icon-list__content">Does your Section 508 Program team have the bandwidth to lead initiatives to advance program maturity, or does under-resourcing force it to operate in a reactive mode? See <a href="{{site.baseurl}}/manage/developing-a-budget-for-a-section-508-program/">Developing a Budget for a Section 508 Program</a>.
      </div>
    </li>
    <li class="usa-icon-list__item">
      <div class="usa-icon-list__icon text-green">
    ...
    <li class="usa-icon-list__item">
      ...
      <div class="usa-icon-list__content">Have you assessed what are the biggest ICT Accessibility risks to the organization or the specific program in question?</div>
    </li>
    <li class="usa-icon-list__item">
      <div class="usa-icon-list__icon text-green">
        <svg class="usa-icon" aria-hidden="true" role="img"><use href="{{ site.baseurl }}/assets/img/sprite.svg#help"></use></svg>
        ...
        <tr>
          ...
          <td>Team members should have experience with:
            <ul>
              ...
              <li><a href="{{site.baseurl}}/manage/section-508-help-desk/">Help desk support</a> and complaint management</li>
              ...
              <li><a href="{{site.baseurl}}/manage/governance/ict-accessibility-and-risk-management/">Risk assessment</a>, planning, and management</li>
        ...
        <tr>
          ...
          <td>Similar to the skills required of a <a href="{{site.baseurl}}/manage/program-manager-responsibilities/">Section 508 Program Manager</a>, team members should have in-depth knowledge of:
            <ul>
              ...
              <li><a href="{{site.baseurl}}/buy/understanding-section-508-exceptions/">Exceptions to the Section 508 standards</a> and how and when to apply these exceptions.</li>
...
<div id="checklist-quick-links" class="itad-card-group margin-bottom-5">
  ...
  <div class="itad-card__body">
    ...
    <ul>
      ...
      <li><a href="{{site.baseurl}}/manage/section-508-help-desk/">Managing a Section 508 Help Desk</a></li>
