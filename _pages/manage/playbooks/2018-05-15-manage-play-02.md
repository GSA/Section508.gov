...
permalink: manage/playbooks/technology-accessibility-playbook/02/
redirect_from: 
...
<ul class="usa-icon-list maxw-full">
  <li class="usa-icon-list__item">
    <div class="usa-icon-list__icon text-green">
      <svg class="usa-icon" aria-hidden="true" role="img"><use href="{{ site.baseurl }}/assets/img/sprite.svg#verified"></use></svg>
    </div>
...
<ul class="usa-icon-list maxw-full">
  ...
  <li class="usa-icon-list__item">
    ...
    <div class="usa-icon-list__content"><strong>Technology Lifecycle Activities:</strong> Measures the extent to which your agency conducts validation of Section 508 requirements to ensure incorporation into agency life cycle activities, including enterprise architecture, design, development, testing, deployment, and ongoing maintenance activities.<br><br>Enterprise life cycles are used to define the end-to-end approach to approving, building, deploying, and supporting agency technology. Section 508 requirements should be incorporated from the beginning of the enterprise life cycle, and included in all stages of the enterprise life cycle. The *least effective* and *most expensive* approach to supporting compliance is to treat Section 508 requirements as an afterthought in response to test results, or worse, in response to complaints from people with disabilities. The *most effective* and *least expensive* approach is to consider Section 508 requirements at all stages of the enterprise life cycle. This is analogous to the saying “it’s cheaper and easier to use an eraser to modify an architectural drawing than a sledgehammer to tear down a wall.”</div>
  </li>
  <li class="usa-icon-list__item">
    <div class="usa-icon-list__icon text-green">
      <svg class="usa-icon" aria-hidden="true" role="img"><use href="{{ site.baseurl }}/assets/img/sprite.svg#verified"></use></svg>
...
<div class="usa-accordion usa-accordion--multiselectable" data-allow-multiple>
  ...
  <div id="m-a1" class="usa-accordion__content">
    <table id="10-1-0" class="usa-table usa-table--borderless striped grid-col-desktop">
      <caption>Table 1: Play 2 Basic Checklist</caption>
      <thead>
        <tr>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Use data from the <a href="{{site.baseurl}}/manage/section-508-assessment/">Section 508 Annual Assessment</a> to help guide your decisionmaking on which metrics to track.</td>
        </tr>
      </tbody>
    </table>
  </div>
        ...
        <tr>
          ...
          <td>Assess the maturity of the Section 508 Program team’s collaboration with offices that support:
            <ul>
              ...
              <li>Align Accessibility with Development Processes (<a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook/09/">Play 9</a>),</li>
              ...
              <li>Issue Resolution and Compliance Enforcement (<a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook/12/">Play 11</a>), and</li>
              <li>Legal</li>
              <li>Reasonable Accommodations (Section 504 and 501)</li>
              <li>Security &amp; Privacy</li>
              <li>Testing, Validation, and Compliance Tracking (<a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook/12/">Play 10</a>),</li>
              <li>Training &amp; Skills Development (<a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook/12/">Play 12</a>)&mdash;Internal technology design, development, configuration, deployment, and maintenance</li>
...
* [KPIs for Play 1: Establish a Section 508 Program Manager to lead compliance efforts]({{site.baseurl}}/manage/playbooks/technology-accessibility-playbook/01/#key-performance-indicators-kpi)
* [KPIs for Play 3: Develop a Section 508 Accessibility Roadmap]({{site.baseurl}}/manage/playbooks/technology-accessibility-playbook/03/#key-performance-indicators-kpi)
* [KPIs for Play 4: Establish a Section 508 Policy]({{site.baseurl}}/manage/playbooks/technology-accessibility-playbook/04/#key-performance-indicators-kpi) 
* [KPIs for Play 5: Develop a Section 508 Program Team]({{site.baseurl}}/manage/playbooks/technology-accessibility-playbook/05/#key-performance-indicators-kpi)
* [KPIs for Play 6: Collaborate with the federal accessibility community]({{site.baseurl}}/manage/playbooks/technology-accessibility-playbook/06/#key-performance-indicators-kpi)
* [KPIs for Play 7: Integrate accessibility needs into requirements and design]({{site.baseurl}}/manage/playbooks/technology-accessibility-playbook/07/#key-performance-indicators-kpi)
* [KPIs for Play 8: Integrate accessibility needs into market research and acquisition processes]({{site.baseurl}}/manage/playbooks/technology-accessibility-playbook/08/#key-performance-indicators-kpi) 
* [KPIs for Play 9: Integrate accessibility needs into development processes ]({{site.baseurl}}/manage/playbooks/technology-accessibility-playbook/09/#key-performance-indicators-kpi)
...
<div id="checklist-quick-links" class="itad-card-group margin-bottom-5">
  ...
  <div class="itad-card__body">
    ...
    <ul>
      <li><a href="{{site.baseurl}}/manage/accessibility-kpi/">Accessibility Conformance KPIs</a></li>
      <li><a href="{{site.baseurl}}/manage/section-508-assessment/">Governmentwide Section 508 Annual Assessment</a></li>
    </ul>
  </div>
</div>
...
<div id="related-resources-guidance" class="itad-card-group margin-bottom-5">
  ...
  <div class="itad-card__body">
    ...
    <ul>
      <li><a href="https://www.section508.gov/manage/accessibility-kpi/">Accessibility Conformance KPIs</a></li>
      <li><a href="https://www.section508.gov/manage/section-508-assessment/2024/introduction/">FY24 Governmentwide Section 508 Assessment</a>-   <a href="https://obamawhitehouse.archives.gov/omb/circulars_a123_rev#:~:text=Purpose.,financial%20reporting%20(Appendix%20A">OMB Circular A-123: Management Responsibility for Internal Control</a>)</li>
      <li><a href="https://www.whitehouse.gov/wp-content/uploads/2023/09/M-23-22-Delivering-a-Digital-First-Public-Experience.pdf">OMB Memo M-23-22: Delivering a Digital First Public Experience</a></li>
...
<div id="prev-next-section">
    <a class="prev-page" title="Go to Play 1" 
      href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook/01"> < Play 1</a>
    <a class="prev-page" title="Go to Play 3"
      href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook/03"> 
      Play 3 ></a>
</div>
