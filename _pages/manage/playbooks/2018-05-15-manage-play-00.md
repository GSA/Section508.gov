...
permalink: manage/playbooks/technology-accessibility-playbook/00/
redirect_from:
...
<div class="tablet:grid-col" style="margin: auto; max-width: 100%; text-align: center; padding: 10px 0px">
   <div class="margin-top-1"><img src="{{site.baseurl}}/assets/images/[path]/[file-name.jpg]" alt="" aria-describedby="figure-1" class="border-2px border-base-light shadow-2 padding-1">
   </div>
...
Section 1 says: "Program Foundations, Leadership, and Governance (Plays 1-4) including:
...
Performance Accountability for Leadership (Play 4), and
Policy Integration Across the Agency (Play 4)"

Section 2 says: "Integration into Agency Operations (Plays 5-8): Budget Considerations for Accessibility (Play 5),
...
Align Accessibility Needs into Design Processes (Play 7), and
Embedding Accessibility into the Acquisition Process (Play 8)"

Section 3 says: "Cont: inuous Improvement, Compliance and Workforce Development (Plays 9-12): Align Accessibility with Development Processes (Play 9), Testing, Validation, and Compliance Tracking (Play 10),
Issue Resolution and Compliance Enforcement (Play 11), and
...
<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  <ul class="usa-icon-list tablet:grid-col">
    <li class="usa-icon-list__item">
        ...
        <div class="usa-icon-list__content">See <a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook-intro/play01/" target="_blank" class="usa-link--external">Play 1: Establish a Section 508 Program Manager to Lead Compliance Efforts</a> for additional details on leadership roles.</div>
    </li>
  </ul>
</div>
...
<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  <ul class="usa-icon-list tablet:grid-col">
    <li class="usa-icon-list__item">
        <div class="usa-icon-list__icon text-red"><svg class="usa-icon" aria-hidden="true" role="img"><use xlink:href="{{ site.baseurl }}/assets/images/sprite.svg#push_pin"></use></svg></div>
        <div class="usa-icon-list__content">(See <a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook-intro/play02/" target="_blank" class="usa-link--external">Play 2: Assess Your Section 508 Program Maturity</a> for detailed guidance on program assessment.)</div>
    </li>
  </ul>
</div>
...
* Align[  performance metrics](https://www.section508.gov/manage/accessibility-kpi/) with agency-wide IT and procurement processes

<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  <ul class="usa-icon-list tablet:grid-col">
    <li class="usa-icon-list__item">
        <div class="usa-icon-list__icon text-red"><svg class="usa-icon" aria-hidden="true" role="img"><use xlink:href="{{ site.baseurl }}/assets/images/sprite.svg#push_pin"></use></svg></div>
        <div class="usa-icon-list__content">See <a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook-intro/play03/">Play 3: Develop a Section 508 Accessibility Roadmap</a> for guidance on setting accessibility goals and metrics.</div>
    </li>
  </ul>
</div>
...
<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  <ul class="usa-icon-list tablet:grid-col">
    <li class="usa-icon-list__item">
        <div class="usa-icon-list__icon text-red"><svg class="usa-icon" aria-hidden="true" role="img"><use xlink:href="{{ site.baseurl }}/assets/images/sprite.svg#push_pin"></use></svg></div>
        <div class="usa-icon-list__content">See <a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook-intro/play04/">Play 4: Establish a Section 508 Policy</a> for additional details on policy integration and leadership accountability.</div>
    </li>
  </ul>
</div>

#### Policy Integration Across the Agency
Each agency should adopt and enforce Section 508 policies at the department, agency, and division levels. Policies should specify:
...
<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  <ul class="usa-icon-list tablet:grid-col">
    <li class="usa-icon-list__item">
        <div class="usa-icon-list__icon text-red"><svg class="usa-icon" aria-hidden="true" role="img"><use xlink:href="{{ site.baseurl }}/assets/images/sprite.svg#push_pin"></use></svg></div>
        <div class="usa-icon-list__content">See <a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook-intro/play04/">Play 4: Establish a Section 508 Policy</a> for guidance on policy development.</div>
    </li>
  </ul>
</div>
...
<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  <ul class="usa-icon-list tablet:grid-col">
    <li class="usa-icon-list__item">
        <div class="usa-icon-list__icon text-red"><svg class="usa-icon" aria-hidden="true" role="img"><use xlink:href="{{ site.baseurl }}/assets/images/sprite.svg#push_pin"></use></svg></div>
        <div class="usa-icon-list__content"><p>See <a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook-intro/play05/">Play 5: Develop a Section 508 Program Team</a> for best practices on governance and coordination</p></div>
    </li>
  </ul>
</div>
...
<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  <ul class="usa-icon-list tablet:grid-col">
    <li class="usa-icon-list__item">
        <div class="usa-icon-list__icon text-red"><svg class="usa-icon" aria-hidden="true" role="img"><use xlink:href="{{ site.baseurl }}/assets/images/sprite.svg#push_pin"></use></svg></div>
        <div class="usa-icon-list__content"><p>See <a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook-intro/play05/">Play 5: Develop a Section 508 Program Team</a> for best practices on resource allocation.</p></div>
    </li>
  </ul>
</div>
...
<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  <ul class="usa-icon-list tablet:grid-col">
    <li class="usa-icon-list__item">
        <div class="usa-icon-list__icon text-red"><svg class="usa-icon" aria-hidden="true" role="img"><use xlink:href="{{ site.baseurl }}/assets/images/sprite.svg#push_pin"></use></svg></div>
        <div class="usa-icon-list__content"><p>See <a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook-intro/play06/">Play 6: Collaborate with the Federal Accessibility Community</a> for strategies on distributed responsibility.</p></div>
    </li>
  </ul>
</div>
...
<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  <ul class="usa-icon-list tablet:grid-col">
    <li class="usa-icon-list__item">
        <div class="usa-icon-list__icon text-red"><svg class="usa-icon" aria-hidden="true" role="img"><use xlink:href="{{ site.baseurl }}/assets/images/sprite.svg#push_pin"></use></svg></div>
        <div class="usa-icon-list__content"><p>See <a href="{{site.baseurl}}">Play 6: Collaborate with the federal accessibility community</a>  for collaboration strategies.</p></div>
    </li>
  </ul>
</div>
...
<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  <ul class="usa-icon-list tablet:grid-col">
    <li class="usa-icon-list__item">
        <div class="usa-icon-list__icon text-red"><svg class="usa-icon" aria-hidden="true" role="img"><use xlink:href="{{ site.baseurl }}/assets/images/sprite.svg#push_pin"></use></svg></div>
        <div class="usa-icon-list__content"><p>See <a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook-intro/play07/">Play 7: Integrate accessibility needs into requirements and design processes</a></p></div>
    </li>
  </ul>
</div>

(See [Play 7: Integrate accessibility needs into requirements and design processes]({{site.baseurl}}/manage/playbooks/technology-accessibility-playbook-intro/play07/))
...
<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  <ul class="usa-icon-list tablet:grid-col">
    <li class="usa-icon-list__item">
        <div class="usa-icon-list__icon text-red"><svg class="usa-icon" aria-hidden="true" role="img"><use xlink:href="{{ site.baseurl }}/assets/images/sprite.svg#push_pin"></use></svg></div>
        <div class="usa-icon-list__content"><p>See <a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook-intro/play08/">Play 8: Integrate accessibility needs into market research and acquisition processes</a>.</p></div>
    </li>
  </ul>
</div>
...
<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  <ul class="usa-icon-list tablet:grid-col">
    <li class="usa-icon-list__item">
        <div class="usa-icon-list__icon text-red"><svg class="usa-icon" aria-hidden="true" role="img"><use xlink:href="{{ site.baseurl }}/assets/images/sprite.svg#push_pin"></use></svg></div>
        <div class="usa-icon-list__content"><p>See <a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook-intro/play09/">Play 9: Integrate Accessibility needs into Development Processes</a> for more practices.</p></div>
    </li>
  </ul>
</div>
...
<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  <ul class="usa-icon-list tablet:grid-col">
    <li class="usa-icon-list__item">
        <div class="usa-icon-list__icon text-red"><svg class="usa-icon" aria-hidden="true" role="img"><use xlink:href="{{ site.baseurl }}/assets/images/sprite.svg#push_pin"></use></svg></div>
        <div class="usa-icon-list__content"><p>See <a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook-intro/play10/">Play 10: Conduct ICT Accessibility Testing</a> for methodologies on accessibility testing and compliance tracking.</p></div>
    </li>
  </ul>
</div>
...
<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  <ul class="usa-icon-list tablet:grid-col">
    <li class="usa-icon-list__item">
        <div class="usa-icon-list__icon text-red"><svg class="usa-icon" aria-hidden="true" role="img"><use xlink:href="{{ site.baseurl }}/assets/images/sprite.svg#push_pin"></use></svg></div>
        <div class="usa-icon-list__content"><p>See <a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook-intro/play11/">Play 11: Track and Resolve Accessibility Issues</a> for guidance on issue management.</p></div>
    </li>
  </ul>
</div>
...
* Develop and distribute internal training materials aligned with the [Department of Homeland Security (DHS) Trusted Tester Process & Certification Program](https://www.section508.gov/test/trusted-tester/) (DHS Trusted Tester) or <a href="https://ictbaseline.access-board.gov/" target="_blank" class="usa-link--external">Baseline-aligned testing</a> methodologies
...
<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  <ul class="usa-icon-list tablet:grid-col">
    <li class="usa-icon-list__item">
        <div class="usa-icon-list__icon text-red"><svg class="usa-icon" aria-hidden="true" role="img"><use xlink:href="{{ site.baseurl }}/assets/images/sprite.svg#push_pin"></use></svg></div>
        <div class="usa-icon-list__content"><p>See <a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook-intro/play12/">Play 12: Educate the Workforce</a> for guidance on training programs.</p></div>
    </li>
  </ul>
</div>
