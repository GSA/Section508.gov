...
<div class="tablet:grid-col" style="margin: auto; max-width:65%; text-align: center; padding: 10px 0px">
   <div class="margin-top-1"><img src="{{site.baseurl}}/assets/images/playbooks-tap-01-figure-01.png" alt="" aria-describedby="figure-1" class="border-0px border-base-light shadow-0 padding-1">
   </div>
...
<section id="playbooks-tap-cards" class="usa-section">
