          ...
          <td>Assess your agency’s current approach(es) to:
            <ul>
              <li>Validating ICT prior to procurement or deployment
                <ul>
                  <li>Conducting <a href="{{site.baseurl}}/test/">Section 508 conformance testing</a>. Ask yourself:
                    <ul>
...
<div class="margin-bottom-3">
  <button id="expand-all" class="usa-button" data-action="expand" data-target="accordion-group-kpi">Expand all</button>
  <button id="collapse-all" class="usa-button usa-button" data-action="collapse" data-target="accordion-group-kpi">Collapse all</button>
</div>
