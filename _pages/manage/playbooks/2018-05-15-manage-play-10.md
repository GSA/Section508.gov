...
permalink: manage/playbooks/technology-accessibility-playbook/play-10/
redirect_from:
    ...
    <table id="10-1-0" class="usa-table usa-table--borderless striped grid-col-desktop">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Develop and document accessibility testing policy and procedures that define:</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>Develop or attain Section 508 testing expertise:
            <ul>
...
<div id="checklist-quick-links" class="itad-card-group margin-bottom-5">
  ...
  <div class="itad-card__body">
    ...
    <ul>
      ...
      <li><a href="https://www.section508.gov/tools/glossary/#g">Glossary term: Governance, Risk, and Compliance (GRC) Tools</a></li>
