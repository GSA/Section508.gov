    ...
    <table id="10-1-0" class="usa-table usa-table--borderless striped grid-col-desktop">
      ...
      <tbody>
        <tr>
          ...
          <td><a href="{{site.baseurl}}/test/testing-lifecycle-overview/">Plan for testing in the ICT lifecycle</a>. This includes pre-procurement accessibility evaluations. </td>
        </tr>
        <tr>
          ...
          <td>Assess your agency’s current approach(es) to:
            <ul>
              <li>Validating ICT prior to procurement or deployment
                <ul>
                  <li>Conducting <a href="https://www.section508.gov/test/">Section 508 conformance</a> testing. Ask yourself:</li>
        ...
        <tr>
          ...
          <td>Develop and document accessibility testing policy and procedures that define:
            <ul>
              ...
              <li><a href="https://www.section508.gov/manage/roles/">Roles and responsibilities</a> of each member of the project team including developers, testers, and management.</li>
              <li>How <a href="https://www.section508.gov/test/">Section 508 conformance testing</a> will be conducted?</li>
              ...
              <li>What ICT accessibility testing tools and methodologies will be approved for use?
                <div class="grid-col-12 border-base radius-lg padding-1 bg-primary-lighter border-1px margin-top-1">
                  <strong>Example:</strong> <a href="{{site.baseurl}}/test/ict-testing-baseline-portfolio/">ICT Testing Baseline-aligned</a> test processes, such as the <a href="{{site.baseurl}}/test/trusted-tester/">DHS Trusted Tester testing methodology</a>.
                </div>              
              </li>
              <li>How testing results will be tracked and monitored? See <a href="">Essential Elements of a Test Report</a>. NEED LINK</li>
            </ul>
          </td>
        </tr>
        <tr>
...
<div id="templates-tools-resources" class="itad-card-group margin-bottom-5">
  ...
  <div class="itad-card__body">
    ...
    <ul>
      <li><a href="https://www.section508.gov/develop/incorporating-accessibility-conformance/">Effective Methods and Tools for Incorporating Accessibility Conformance Validation within Development Processes</a></li>
      <li><a href="https://ictbaseline.access-board.gov/">ICT Testing Baseline Portfolio</a></li>
      <li><a href="https://www.section508.gov/test/testing-overview/">Overview of Testing Methods for 508 Conformance</a></li>
      <li><a href="https://www.section508.gov/develop/user-stories/">Sample User Stories</a></li>
      <li><a href="https://www.section508.gov/test/documents/">Test Electronic Documents</a></li>
      <li><a href="https://www.section508.gov/test/web-software/">Test Websites and Software</a></li>
    </ul>
  </div>
</div>
<div id="checklist-quick-links" class="itad-card-group margin-bottom-5">
  ...
  <div class="itad-card__body">
    ...
    <ul>
      <li><a href="https://www.section508.gov/test/testing-lifecycle-overview/">Testing Lifecycle Overview</a></li>
      <li><a href="https://www.section508.gov/test/">Test for Accessibility</a></li>
      <li><a href="https://www.section508.gov/manage/roles/">Roles and Responsibilities</a></li>
      <li><a href="https://www.section508.gov/test/ict-testing-baseline-portfolio/">ICT Testing Baseline Portfolio</a></li>
      <li><a href="https://www.section508.gov/test/elements-of-an-accessibility-test-report/">Essential Elements of a Test Report</a></li>
      <li><a href="https://www.section508.gov/manage/roles/attain-section-508-testing-expertise/">How to Attain Section 508 Testing Expertise</a></li>
      <li>Glossary term:<a href="https://www.section508.gov/tools/glossary/#g">Governance, Risk, and Compliance (GRC) Tools</a></li>
      <li><a href="https://www.section508.gov/test/usability-testing-with-people-with-disabilities/">Tips for Usability Testing with users with disabilities</a></li>
    </ul>
  </div>
</div>
<div id="related-resources-guidance" class="itad-card-group margin-bottom-5">
  ...
  <div class="itad-card__body">
    ...
    <ul>
      <li><a href="https://www.section508.gov/buy/accessibility-in-procurement-pre-solicitation-2/">Accessibility In Procurement II: Solicitation &amp; Post-Solicitation</a></li>
      <li><a href="https://www.section508.gov/manage/accessibility-kpi/">Organizational IT Accessibility Key Performance Indicators</a></li>
      ...
      <li><a href="https://www.section508.gov/buy/understand-claims/">Understanding Vendor Claims in Accessibility Conformance Reports for Section 508 Conformance</a></li>
    </ul>
  </div>
</div>
