...
type: report2025
title: "FY 2025 Assessment Style Guide"
topic: Law (law)
sub-topic: Reporting
audience:
...
## Colors and Contrast
### Borders and Fills
<div class="grid-col-12 border-base radius-lg padding-1 text-white margin-bottom-1" style="border: 1px solid black; background-color: #56093b;">
KMSOC Purple: #56093b
</div>
<div class="grid-col-12 border-base radius-lg padding-1 text-white margin-bottom-1" style="border: 1px solid black; background-color: #481441;">
USWDS violet-warm-80v: #481441
</div>
<div class="grid-col-12 border-base radius-lg padding-1 text-white margin-bottom-1" style="border: 1px solid black; background-color: #711e6c;">
USWDS violet-warm-70v: #711e6c
</div>
<div class="grid-col-12 border-base radius-lg padding-1 text-white margin-bottom-1" style="border: 1px solid black; background-color: #93348c;">
USWDS violet-warm-60v: #93348c
</div>
<div class="grid-col-12 border-base radius-lg padding-1 margin-bottom-1" style="border: 1px solid black; background-color: #ee83ff;">
USWDS violet-warm-30v: #ee83ff
</div>
<div class="grid-col-12 border-base radius-lg padding-1 margin-bottom-1" style="border: 1px solid black; background-color: #f4b2ff;">
USWDS violet-warm-20v: #f4b2ff
</div>
<div class="grid-col-12 border-base radius-lg padding-1 margin-bottom-1" style="border: 1px solid black; background-color: #fbdcff;">
USWDS violet-warm-10v: #fbdcff
</div>
<div class="grid-col-12 border-base radius-lg padding-1 margin-bottom-1" style="border: 1px solid black; background-color: #fef2ff;">
USWDS violet-warm-5v: #fef2ff
</div>

### Text and Charts
<div class="grid-col-12 border-base radius-lg padding-1 text-white margin-bottom-1" style="border: 1px solid black; background-color: #0076d6;">
USWDS text-blue: #0076d6
</div>
<div class="grid-col-12 border-base radius-lg padding-1 text-white margin-bottom-1" style="border: 1px solid black; background-color: #538200;">
USWDS text-green: #538200
</div>
<div class="grid-col-12 border-base radius-lg padding-1 text-white margin-bottom-1" style="border: 1px solid black; background-color: #e52207;">
USWDS text-red: #e52207
</div>
...
* Save to [2025 Assessment Images](https://drive.google.com/drive/folders/1OniOUI2D8AiFJS_1qzPUjODHvsXdJSmX) folder so that the figure desc match
* Mike will resolve Fure # and Table # secquence and file names at time of publishing
...
<div class="border-base radius-lg padding-1 margin-bottom-2" style="width: 100%; border: 1px solid #93348c; background-color: #fef2ff;">
   border: <!--violet-warm-60v:-->#93348c, bg: <!--violet-warm-5v:-->#fef2ff
</div>

### Asse4ssment Altternate
<div class="border-base radius-lg padding-1 margin-bottom-2" style="width: 100%; border: 1px solid #93348c; background-color: #fbdcff;">
   border <!--violet-warm-60v:-->#93348c, bg: <!--violet-warm-10v:-->#fbdcff
</div>

### Sitewide Defaults
<div class="grid-col-12 summary-box">
  border: #000000, bg: #f5f9fc
</div>

### Sitewide Alternate
<div class="grid-col-12 summary-box-alt">
  border: #71767a, bg: #d9e8f6
</div>
...
## Table: Default (Borderless striped)
