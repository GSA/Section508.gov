...
{% comment %} Version 4.6: Added data_label so that whats new can distinguish between new (Created) and updated (updated) pages appended to the description. {% endcomment %}
