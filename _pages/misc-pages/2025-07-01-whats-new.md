...
{% comment %} Version 4.5: Normalized packed/restored field order to prevent index drift; removed debug parts output; kept conditional Updated date + description-alt display. {% endcomment %}
...
{% for page in all_entries %}
  {% unless page.exclude-changelog %}
    ...
    epoch|title|url|date|description|description-alt
    {%- endcomment -%}
...
Field order remains consistent: epoch|title|url|date|description|description-alt
{%- endcomment -%}
    ...
    <li class="usa-icon-list__item">
      ...
      <div class="usa-icon-list__content">
        ...
        {% if parts[4] %}
          {{ parts[4] }}
        {% endif %}
        <em>Updated {{ parts[3] | date: "%B %Y" }}{% if parts[5] and parts[5] != "" %}:{% else %}.{% endif %}</em>{% if parts[5] %} {{ parts[5] }}{% endif %}
      </div>
    </li>
  {% endfor %}
</ul>
