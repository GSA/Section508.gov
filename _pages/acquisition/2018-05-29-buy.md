...
permalink: buy/
description: Learn how to buy accessible ICT products and services by incorporating Section 508 requirements throughout the federal acquisition lifecycle.
disclaimer: true
audience: 
- Buyers
...
<div class="grid-col-12 summary-box--left">
  <h5 class="font-body-xs margin-y-0">What is a vendor?</h5>
...
Section508.gov has resources to help you [define accessibility criteria in contracts][30]. Review the sample language that you can use to properly document provisions, clauses, <a href="{{site.baseurl}}/buy/integrate-section-508-in-qasps/">Quality Assurance Surveillance Plans</a>, and acceptance criteria when preparing solicitations, statements of work, or other procurement documents. Include these accessibility requirements in your solicitation.
...
<h2 id="learn">
 ...
 [20]: {{site.baseurl}}/art/
 [21]: {{site.baseurl}}/art/
 [22]: https://www.section508.gov/~assets/files/508-standards-applicability-checklist.docx
 [23]: {{site.baseurl}}/buy/standards-exceptions
 [24]: https://www.itic.org/policy/accessibility/vpat
 [25]: https://www.acquisitiongateway.gov/
 [26]: https://hallways.cap.gsa.gov/app/#/solutionsfinder
 [27]: https://vsc.gsa.gov/drupal/node/35
