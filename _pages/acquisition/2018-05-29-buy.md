...
Section508.gov has resources to help you [define accessibility criteria in contracts][30]. Review the sample language that you can use to properly document provisions, clauses, <a href="{{site.baseurl}}/acquisition/buy/integrate-section-508-in-qasps/">Quality Assurance Surveillance Plans</a>, and acceptance criteria when preparing solicitations, statements of work, or other procurement documents. Include these accessibility requirements in your solicitation.
