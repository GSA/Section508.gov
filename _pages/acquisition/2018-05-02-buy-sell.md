  ...
  <li class="tablet:grid-col-6 usa-card">
    <div class="usa-card__container radius-md">
      ...
      <div class="usa-card__body">
        ...
        <ul class="add-list-reset">
          <li><a href="{{site.baseurl}}/sell/vpat/">Voluntary Product Accessibility Template (VPAT<sup>&trade;</sup>)</a></li>
        </ul>
        <ul class="add-list-reset">
          <li><a href="{{site.baseurl}}/sell/acr-vpat-faq/">ACR/VPAT<sup>&trade;</sup> FAQ</a></li>
        </ul>
        <ul class="add-list-reset">
          <li><a href="{{site.baseurl}}/sell/how-to-create-acr-with-vpat/">How to Create an ACR Using A VPAT<sup>&trade;</sup></a></li>
        </ul>
      </div>
    </div>
  </li>
