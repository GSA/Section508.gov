...
Section 508 Regulation uses the word “exception” for General Exceptions (E202) . Additionally, specific provisions within Section 508 and some WCAG 2 Success Criteria also have exceptions. This article only covers General Exceptions (E202).
...
## Legacy ICT
<div class="grid-col-8 border-base padding-1 margin-x-auto border-y text-primary" style="width:87%;">
...
<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  Note: Refer to your agency's Section 508 policy for details on exceptions, determinations and authorizations.
</div>
