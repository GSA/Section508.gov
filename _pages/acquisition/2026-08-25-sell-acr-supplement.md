...
As a best practice, vendors can provide the ACR Issue Detail Supplement as an additional page in the same document as the full ACR (often created using a VPAT®) or add product, version, manufacturer, and point of contact information to the supplement if provided in a separate document.
