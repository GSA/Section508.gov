...
description: View the complete list of Section 508 requirements generated by the Accessibility Requirements Tool (ART). Use these standards to guide ICT procurement.
permalink: tools/list-of-art-requirements/
redirect_from:
- ict-accessibility/
topic: "Tools (tools)"
...
updated: 2025-03-06 
---
This article includes a complete list of all Section 508 requirements statements generated by the <a href="http://www.section508.gov/art/" target="_blank" class="usa-link--external">Accessibility Requirements Tool (ART)</a>. Each requirement is taken from the <a href="https://www.access-board.gov/ict/" target="_blank" class="usa-link--external">Section 508 Standards</a> and listed here for your convenience. Government buyers and requirements officials can use these requirements to guide digital accessibility efforts, procurement, assess compliance, and support accessibility goals.

Agencies are encouraged to use ART to "identify applicable accessibility requirements from Section 508 standards and incorporate them into procurement and contracting documentation." By including Section 508 requirements in ICT solicitations, agencies ensure compliance with [Section 508 of the Rehabilitation Act (29 U.S.C. 794d)]({{site.baseurl}}/manage/laws-and-policies/section-508-law/), <a href="https://www.acquisition.gov/far/part-39#FAR_Subpart_39_2" target="_blank" class="usa-link--external">Federal Acquisition Regulations (FAR) (Subpart 39.2)</a>, and <a href="https://bidenwhitehouse.archives.gov/omb/management/ofcio/m-24-08-strengthening-digital-accessibility-and-the-management-of-section-508-of-the-rehabilitation-act/" target="_blank" class="usa-link--external">OMB policy (M-24-08)</a>, while improving efficiencies and saving costs. 

<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  To access and review the Section 508 Standards, please visit the U.S. Access Board's <a href="https://www.access-board.gov/ict/" target="_blank" class="usa-link--external">Section 508 Standards</a> page for more detailed information.
</div>
