...
<ul class="usa-card-group" style="justify-content:center">
  <li class="tablet:grid-col-4 usa-card margin-top-4">
  ...
  <li class="tablet:grid-col-4 usa-card">
    <div class="usa-card__container radius-md border-top-none">
      ...
      <header class="usa-card__header">
        <h2 class="usa-card__heading font-family-sans"><a href="{{site.baseurl}}/tools/openacr-repository/">OpenACR Repository</a></h2>
      </header>
      <div class="usa-card__body">
