...
<ul class="usa-card-group">
    ...
    <div class="usa-card__container">
      ...
      <div class="usa-card__media">
        <div class="usa-card__img">
          <img src="https://assets.section508.gov/assets/images/thumbnails/thumb-training-tools-art.jpg" alt="ART logo"/>
        </div>
      </div>
  ...
  <li class="usa-card tablet:grid-col-6 widescreen:grid-col-6">
    <div class="usa-card__container">
      ...
      <div class="usa-card__media">
        <div class="usa-card__img">
          <img src="https://assets.section508.gov/assets/images/thumbnails/thumb-training-tools-srt.jpg" alt="SRT logo"/>
        </div>
      </div>
      <div class="usa-card__body">
  ...
  <li class="usa-card tablet:grid-col-6 widescreen:grid-col-6">
    <div class="usa-card__container">
      ...
      <div class="usa-card__media">
        <div class="usa-card__img">
          <img src="https://assets.section508.gov/assets/images/thumbnails/thumb-training-tools-acreditor.jpg" alt="ACR Editor" />
        </div>
      </div>
      <div class="usa-card__body">
  ...
  <li class="usa-card tablet:grid-col-6 widescreen:grid-col-6">
    <div class="usa-card__container">
      ...
      <div class="usa-card__media">
        <div class="usa-card__img">
          <img src="https://assets.section508.gov/assets/images/thumbnails/thumb-training-tools-acrrepository-soon.jpg" alt="ACR Repository - Coming Soon" aria-hidden="true"/>
        </div>
      </div>
      <div class="usa-card__body">
