...
description: In Module 11 of the Accessible Name &amp; Description Inspector (ANDI) Tool video series, learn how to use the ANDI <em>Frames</em> module to detect and verify that all frames provide a descriptive title which adequately identifies the frame’s content.
disclaimer: 
audience:
- "Federal Employees"
...
<video controls="controls" poster="{{site.baseurl}}/assets/images/thumbnails/training-video-andi-poster.jpg" data-vscid="3qesx4ovd" style="width:100%" class="radius-lg border-0px"><source src="https://www.section508.gov/~assets/videos/training-video-andi-11-oc.mp4" type="video/mp4"></video>
