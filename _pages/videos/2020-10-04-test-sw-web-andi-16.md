...
description: In Module 16 of the Accessible Name &amp; Description Inspector (ANDI) Tool video series, discover how to use the ANDI <em>Tables</em> module to inspect layout tables for accessibility to verify the table roles and ANDI output does not display table structure elements reserved for data tables.
disclaimer: 
audience:
- Federal Employees
...
<video controls="controls" poster="{{site.baseurl}}/assets/images/thumbnails/training-video-andi-poster.jpg" data-vscid="3qesx4ovd" style="width:100%" class="radius-lg border-0px"><source src="https://www.section508.gov/~assets/videos/training-video-andi-16-oc.mp4" type="video/mp4"></video>
