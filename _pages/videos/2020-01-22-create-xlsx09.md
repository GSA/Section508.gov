...
description: Flashing objects cannot be considered accessible because they can cause seizures and, therefore, should never be used. Warning&colon; This video demonstrates a type of flashing object that should never be used.
disclaimer: 
audience:
- Federal Employees
- Content Creators
...
<video controls="controls" poster="{{site.baseurl}}/assets/images/thumbnails/training-video-xlsx-poster.jpg" data-vscid="3qesx4ovd" style="width:100%" class="radius-lg border-0px"><source src="https://www.section508.gov/~assets/videos/training-video-xlsx-09-oc.mp4" type="video/mp4" /></video>
