...
---
Module 1 of the Accessible Name &amp; Description Inspector (ANDI) Tool video series, get an overview of the Accessible Name & Description Inspector (ANDI) tool, a web accessibility inspection tool, which performs single page testing to automatically detect accessibility issues.
<video controls="controls" data-vscid="3qesx4ovd" style="width:100%"><source src="https://training.section508.gov/assets/videos/training-video-andi-01-oc.mp4" type="video/mp4"></video>
