...
<div class="usa-graphic-list__row container" id="day1">
  ...
  <div class="grid-row welcome" id="welcome">
    ...
    <div class="desktop:grid-col-9 tablet:grid-col-9 cell ltblue agenda-description padding-1">
      <p><span class="speaker-name"><b><a href="{{site.baseurl}}/iaaf/archives/biographies-2021#brumfield">Krystal Brumfield</a></b></span>, Associate Administrator, Office of Government-wide Policy, General Services Administration (GSA)</p>
      <p><span class="speaker-name"><b><a href="{{site.baseurl}}/iaaf/archives/biographies-2021#duckworth">The Honorable Senator Tammy Duckworth</a></b></span>, United States Senator from Illinois</p>
    </div>
  </div>
  ...
  <div class="grid-row break">
    <div class="grid-col-12 cell dark padding-1">
      12:45 A.M. – 12:50 P.M.<br><span class="session-type">Break with Vendor Videos</span>
    </div>
  </div>
