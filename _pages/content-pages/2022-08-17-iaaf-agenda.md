...
<!-- BEGIN DAY 1 WORKSHOP 2 TRACK A --> 
<div class="desktop:grid-col tablet:grid-col cell tan-breakout padding-1 agenda-description" id="d1ws2a">
  ...
  <!-- BEGIN DAY 1 WORKSHOP 2 TRACK B -->  
