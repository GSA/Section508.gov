   ...
   function generateContractHTML()
   {
        ...
        for(i = 0; i < unique_array.length; i++)
      {
        ...
        if(fruits1.length > 0)
        {
         ...
         {
        //   OutputHTML += '<li>Where ICT conforming to one or more requirements in the Revised 508 Standards is not commercially available, the agency shall procure the ICT that best meets the Revised 508 Standards consistent with the agency’s business needs, in accordance with 36 CFR E202.7. Any selection of a product or service that meets less accessibility standards due to a significant difficulty or expense shall only be permitted under an undue burden claim and requires authorization from the DHS Office of Accessible Systems and Technology (OAST) according to DHS Directive 139-05, Office of Accessible Systems and Technology, dated January 29, 2016, Managing the Accessible Systems and Technology Program, dated January 11, 2017 and 36 CFR E202.6.</li>';
         }
         OutputHTML += "</ol>";
