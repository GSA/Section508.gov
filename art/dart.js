...
var OfficialCommunicationsExamplesHTML = '<style>body{font-family: sans-serif;} button:hover, button:focus, input[type=button]{background-color: white; color: black;}button, input[type=button]{padding: 5px 10px; text-align: center;text-decoration: none; display: inline-block; font-size: 16px; margin: 2px 2px; -webkit-transition-duration: 0.4s; transition-duration: 0.4s;  cursor: pointer;  background-color: black;  color: white;  border: 2px solid #555555; font-family: sans-serif;}</style><button onclick="window.close()">Go Back</button><p>Examples of official agency communications that must conform to the Revised Section 508 Standards:</p><ul><li><strong>An emergency notification</strong> (For example:&nbsp; evacuation notifications, active shooter alerts, fire alerts, weather alerts, hazardous materials alerts, and most likely operational alerts regarding facilities availability, e.g. office closures etc.)</li><li><strong>An initial or final decision adjudicating an administrative claim or proceeding</strong>. (For example: an electronic notice or alert of an approved, denied, or pending sent to an individual regarding a claim they have made that requires a government-decision on their behalf.)</li><li><strong>An internal or external program or policy announcement. </strong>(For example:&nbsp; an electronic notification of a new or changed agency policy, or an official announcement regarding an agency program.)</li><li><strong>A notice of benefits, program eligibility, employment opportunity, or personnel action</strong>. (For example:&nbsp; an electronic notice sent to a private citizen or employee describing the government benefits they are entitled to, information on whether an individual is eligible for benefits or participation in a government program, information on status of a submission for employment, a notification of an official personnel action indicating a promotion or other action for a government employee.)</li><li><strong>A formal acknowledgement of receipt.</strong> (For example:&nbsp; an email attachment that as is used to demonstrate that an application for benefits or employment has been received.)&nbsp;</li><li><strong>A survey or questionnaire. </strong>(For example:&nbsp; a training survey, employee survey, a program survey, a questionnaire used to gather information related to gauging satisfaction with a government program.&nbsp; Includes surveys created using electronic document authoring tools &ndash; such as Microsoft Word and Adobe PDF, but also surveys created by automated survey tools.)</li><li><strong>A template or form</strong> (For example: an electronic document template used to create official agency documents, presentations, a web page template created to establish a common look and feel for a website, or an official agency form that must be completed by employees or members of the public.)</li><li><strong>Educational or training materials</strong>. (For example: interactive online training courses, electronic training materials that support online or instructor led training &ndash; such as PowerPoint Training Presentations, Worksheets, Tests, Surveys)</li><li><strong>Intranet content designed as a Web page. </strong>(This is primarily intended for html web pages distributed internally via an agency Intranet.&nbsp; Downloadable video files and documents that are distributed via these sites but do not meet any of the above categories would not fall under this category.</li></ul><p /><button onclick="window.close()">Go Back</button>';
var ICTSolicationExampleHTML = '<style>body{font-family: sans-serif;} button:hover, button:focus, input[type=button]{background-color: white; color: black;}button, input[type=button]{padding: 5px 10px; text-align: center;text-decoration: none; display: inline-block; font-size: 16px; margin: 2px 2px; -webkit-transition-duration: 0.4s; transition-duration: 0.4s;  cursor: pointer;  background-color: black;  color: white;  border: 2px solid #555555; font-family: sans-serif;}</style><button onclick="window.close()">Go Back</button><h1>Information and Communications Technology Examples</h1><p>The Revised 508 Standards apply to when federal departments and agencies develop, procure, maintain, or use Information and Communications Technology (ICT). ICT is defined in <a href="https://www.access-board.gov/guidelines-and-standards/communications-and-it/about-the-ict-refresh/final-rule/text-of-the-standards-and-guidelines">Section E103.4 of the Revised 508 Standards</a> as:</p><p><em>&ldquo;Information technology and other equipment, systems, technologies, or processes, for which the principal function is the creation, manipulation, storage, display, receipt, or transmission of electronic data and information, as well as any associated content&rdquo;</em></p><p>ICT can be obtained directly as a commercially available product, or through a service deliverable that will result in the delivery of new ICT or changes to existing ICT, including:</p><ul><li>ICT that will be provided to the public &amp; internally</li><li>ICT COTS/GOTS licenses</li><li>ICT approved on the TRM</li><li>ICT proof of concepts, pilot efforts, and MVPs</li><li>ICT provided as a service (example &ndash; SaaS, PaaS)</li><li>ICT provided through open source arrangements</li><li>ICT that has an authorized 508 exception</li></ul><p>Note:&nbsp; Contract Services deliverables may result in new ICT being obtained by the agency, including:</p><ul><li>Services to develop, modify, configure, install, maintain, and host ICT</li><li>Services that produce ICT in support of other deliverables (ex. Electronic forms)</li></ul></p><h3>ICT Electronic Content Examples</h3><ul><li>Internet or Intranet websites</li><li>Electronic documents</li><li>Electronic forms</li><li>Electronic document templates</li><li>Electronic emergency notifications</li><li>Electronic surveys</li><li>Electronic reports</li><li>Electronic training materials</li><li>Multimedia (video/audio)</li><li>Interactive maps</li></ul><h3>ICT Software Examples</h3><p>Examples of software that must conform to the Revised Section 508 Standards</p><p><strong>Web, desktop, server, mobile client applications</strong></p><ul><li>Time and attendance software</li><li>DHS productivity applications</li><li>Web forms/applications</li><li>Call Center Support applications</li><li>Workflow applications</li><li>Content management systems</li><li>Learning management systems</li></ul><p><strong>Electronic content and software authoring tools and platforms</strong></p><ul><li>Microsoft Office</li><li>Adobe Acrobat Professional</li><li>Adobe InDesign</li><li>PDF Generators and Converters</li><li>Graphing and Charting Programs</li></ul><p><strong>Software infrastructure</strong></p><ul><li>Operating Systems</li><li>Browsers</li><li>Systems/network administration software</li><li>Collaboration environments</li><li>Remote access software</li><li>User Authentication Software</li><li>Virtual meeting tools (e.g., VOIP, screen shares, remote meetings)</li><li>Cloud Services & Administrative/Reporting Interfaces</li></ul><p><h3>ICT Hardware Examples</h3><p>Examples of hardware that must conform to the Revised Section 508 Standards</p><ul><li>Computers &amp; laptops</li><li>Servers</li><li>Tablets</li><li>Printers and Copiers</li><li>Document Scanners</li><li>Multi-function office machines</li><li>Peripheral Equipment (ex. keyboards)</li><li>Information kiosks and transaction machines</li><li>Mobile phones</li><li>Video Teleconferencing Equipment</li><li>Video Displays & Monitors</li></ul><p /><button onclick="window.close()">Go Back</button>';
var SolicitationLanguageOverviewHTML = '<style>body{font-family: sans-serif;} button:hover, button:focus, input[type=button]{background-color: white; color: black;}button, input[type=button]{padding: 5px 10px; text-align: center;text-decoration: none; display: inline-block; font-size: 16px; margin: 2px 2px; -webkit-transition-duration: 0.4s; transition-duration: 0.4s;  cursor: pointer;  background-color: black;  color: white;  border: 2px solid #555555; font-family: sans-serif;}</style><button onclick="window.close()">Go Back</button><h1>Section 508 Solicitation Language Overview</h1>Text placeholder here...<p /><button onclick="window.close()">Go Back</button>';
var DARTFAQSHTML = '<style>body{font-family: sans-serif;} button:hover, button:focus, input[type=button]{background-color: white; color: black;}button, input[type=button]{padding: 5px 10px; text-align: center;text-decoration: none; display: inline-block; font-size: 16px; margin: 2px 2px; -webkit-transition-duration: 0.4s; transition-duration: 0.4s;  cursor: pointer;  background-color: black;  color: white;  border: 2px solid #555555; font-family: sans-serif;}</style><button onclick="window.close()">Go Back</button><h1>Frequently Asked Questions</h1><h2>When do I need to use DART?</h2><p>You must use DART when your solicitation requires information and communications technology (ICT).&nbsp;</p><p>DART 2.1 must be used to generate Section 508 Requirements language when a contract will be used to obtain information and communications technology (ICT), either directly as a commercially available product, or through a service deliverable that will result in the delivery of new ICT or changes to existing ICT.&nbsp;</p><p>Tip: Even if you are not sure whether you need to include 508 language in your solicitation, the DART Tool is designed to help you figure this out. A ten-minute investment of your time using DART can help you avoid untimely delays when attempting to obtain approval later to issue your solicitation:</p><p>Common situations include:</p><ul><li>New Solicitations</li><li>Task Orders under existing contracts (including contracts managed by other agencies)</li><li>ICT that will be provided to the public &amp; internally</li><li>ICT COTS/GOTS licenses</li><li>ICT approved on the TRM</li><li>ICT proof of concepts, pilot efforts, and MVPs</li><li>ICT provided as a service (example &ndash; SaaS, PaaS)</li><li>ICT provided through open source arrangements</li><li>ICT that has an authorized 508 exception</li><li>Services to develop, modify, configure, install, maintain, and host ICT</li><li>Services that produce ICT in support of other deliverables (ex. Electronic forms)</li></ul><h2>Do I need to have any knowledge of the Section 508 Standards to use DART?</h2><p>No. You do not need any knowledge of Section 508 to answer the questions. DART only asks you to answer questions about what technology products and services you are buying.</p><h2>How should DART be used if a 508 exception applies?</h2><p>DART will ask if any of the technology products have an authorized exception. If you want to claim an exception, you must have an exception authorization # before using DART.&nbsp;</p><p>If you do not already have an authorization and want to request one, use the Accessibility Compliance Management System to make your request.</p><h2>How should DART be used for task and delivery order contract or agreements?</h2><p>You can use DART to create 508 language for task and delivery order contracts and agreements (e.g. blank purchase agreements, indefinite delivery/indefinite quantity agreements) when applicable section 508 requirements can be identified at the contract/agreement level.</p><p>If Section 508 requirements cannot be identified because multiple types of ICT and/or ICT services will be available for purchase under the contract or agreement, the ordering procedures for the contract/agreement must require that the section 508 requirements be identified using DART before placing any order.</p><p>See OCPO Acquisition Alert - July 23, 2018 for more information.</p><h2>Can I continue to use the 508 language from previous solicitations?</h2><p>No. DO NOT copy and paste the 508 language used in a previous solicitation. If the Section 508 language in your solicitation refers to&nbsp;Electronic Information Technology (EIT), it will be out of date and will not be approved by OAST.&nbsp;</p><p>Continued use of the old language runs the risk of introducing ambiguity into your solicitation and resulting contract.&nbsp;</p><p>The new 508 language generated by <a href="https://www.dhs.gov/xlibrary/oast/DART/">DART 2.1</a> provides:</p><ul><li>Tailored requirements based on the type of technology products and services being procured.</li><li>Updated legal provisions to ensure accessibility is supported throughout the life of contract, including requirements for the contractor to use the DHS Trusted Tester Process to validate 508 conformance for web and software developed or modified for use by DHS (using contractor trusted testers personnel).</li><li>Provides specific instructions documenting and supporting accessibility claims in bid proposals, and DHS acceptance criteria for validating claims.</li><li>Refer to the Revised 508 language template for more information.</li></ul><h2>Can I create my own Section 508 solicitation language?&nbsp;</h2><ul><li>The DHS Acquisition Manual (HSAM) 3039.204(e)(2)(ii)) requires solicitation language for information and communications technology to include the Section 508 requirements provided using DART, and for any applicable exceptions to 508 to be properly authorized and documented in the contract file.</li><li>Acquisition Alert - July 23, 2018 outlines requirements for including the revised 508 requirements language in new solicitations and existing contracts and agreements.</li></ul><h2>How was the DART Tool created?</h2><ul><li>The Section 508 Solicitation Language generated by <u><a href="https://www.dhs.gov/xlibrary/oast/DART/">DART 2.1</a></u> was developed jointly by the Office of Accessible Systems and Technology, the Office of Acquisition Policy and Legislation, the Office of General Counsel. The language and business logic were based on recommendations established through a joint effort by the Federal CIO Council Accessibility Community of Practice, the US Access Board, and the General Services Administration to provide government-wide guidance on how to implement the Revised 508 standards.</li><li><u><a href="https://www.dhs.gov/xlibrary/oast/DART/">DART 2.1</a></u> was developed by developed jointly by the Office of Accessible Systems and Technology , with input from various DHS and external stakeholders.</li></ul><h2>Where do I go for assistance with using DART?</h2><ul><li>For questions or assistance, please contact the Accessibility Help Desk:<br /> 202-447-0440 (voice)<br /> 202-447-0582 (fax)<br /><u><a href="mailto:accessibility@hq.dhs.gov">accessibility@hq.dhs.gov</a></u></li></ul><p /><button onclick="window.close()">Go Back</button>';
var Requirements508InfoHTML = '<style>body{font-family: sans-serif;} button:hover, button:focus, input[type=button]{background-color: white; color: black;}button, input[type=button]{padding: 5px 10px; text-align: center;text-decoration: none; display: inline-block; font-size: 16px; margin: 2px 2px; -webkit-transition-duration: 0.4s; transition-duration: 0.4s;  cursor: pointer;  background-color: black;  color: white;  border: 2px solid #555555; font-family: sans-serif;}</style><button onclick="window.close()">Go Back</button><h2>When do I need to include Section 508 requirements in my solicitation?</h2> <p>You must include Section 508 requirements in your statement of work when your solicitation requires the purchase of <a href="javascript:ICTSolicationsExample()">information and communications technology (ICT)</a>. &nbsp;</p><p>Common situations include:</p><ul><li>New Solicitations</li><li>Task Orders under existing contracts (including contracts managed by other agencies)</li><li>ICT that will be provided to the public &amp; internally</li><li>ICT COTS/GOTS licenses</li><li>ICT approved on the TRM</li><li>ICT proof of concepts, pilot efforts, and MVPs</li><li>ICT provided as a service (example &ndash; SaaS, PaaS)</li><li>ICT provided through open source arrangements</li><li>ICT that  has an authorized 508 exception</li><li>Services to develop, modify, configure, install, maintain, and host ICT</li><li>Services that produce ICT in support of other deliverables (ex.&nbsp; Electronic forms)&nbsp;</li></ul></p><button onclick="window.close()">Go Back</button>';
var ICTSolicationExampleHardwareHTML = '<style>body{font-family: sans-serif;} button:hover, button:focus, input[type=button]{background-color: white; color: black;}button, input[type=button]{padding: 5px 10px; text-align: center;text-decoration: none; display: inline-block; font-size: 16px; margin: 2px 2px; -webkit-transition-duration: 0.4s; transition-duration: 0.4s;  cursor: pointer;  background-color: black;  color: white;  border: 2px solid #555555; font-family: sans-serif;}</style><button onclick="window.close()">Go Back</button><h1>Information and Communications Technology Examples</h1><p>The Revised 508 Standards apply to when federal departments and agencies develop, procure, maintain, or use Information and Communications Technology (ICT). ICT is defined in <a href="https://www.access-board.gov/guidelines-and-standards/communications-and-it/about-the-ict-refresh/final-rule/text-of-the-standards-and-guidelines">Section E103.4 of the Revised 508 Standards</a> as:</p><p><em>&ldquo;Information technology and other equipment, systems, technologies, or processes, for which the principal function is the creation, manipulation, storage, display, receipt, or transmission of electronic data and information, as well as any associated content&rdquo;</em></p><h3>ICT Hardware Examples</h3><p>Examples of hardware that must conform to the Revised Section 508 Standards</p><ul><li>Computers &amp; laptops</li><li>Servers</li><li>Tablets</li><li>Printers and Copiers</li><li>Document Scanners</li><li>Multi-function office machines</li><li>Peripheral Equipment (ex. keyboards)</li><li>Information kiosks and transaction machines</li><li>Mobile phones</li></ul><p /><button onclick="window.close()">Go Back</button>';
var ICTSolicationExampleSoftwareHTML = '<style>body{font-family: sans-serif;} button:hover, button:focus, input[type=button]{background-color: white; color: black;}button, input[type=button]{padding: 5px 10px; text-align: center;text-decoration: none; display: inline-block; font-size: 16px; margin: 2px 2px; -webkit-transition-duration: 0.4s; transition-duration: 0.4s;  cursor: pointer;  background-color: black;  color: white;  border: 2px solid #555555; font-family: sans-serif;}</style><button onclick="window.close()">Go Back</button><h1>Information and Communications Technology Examples</h1><p>The Revised 508 Standards apply to when federal departments and agencies develop, procure, maintain, or use Information and Communications Technology (ICT). ICT is defined in <a href="https://www.access-board.gov/guidelines-and-standards/communications-and-it/about-the-ict-refresh/final-rule/text-of-the-standards-and-guidelines">Section E103.4 of the Revised 508 Standards</a> as:</p><p><em>&ldquo;Information technology and other equipment, systems, technologies, or processes, for which the principal function is the creation, manipulation, storage, display, receipt, or transmission of electronic data and information, as well as any associated content&rdquo;</em></p><h3>ICT Software Examples</h3><p>Examples of software that must conform to the Revised Section 508 Standards</p><p><strong>Web, desktop, server, mobile client applications</strong></p><ul><li>Time and attendance software</li><li>DHS productivity applications</li><li>Web forms/applications</li><li>Call Center Support applications</li><li>Workflow applications</li><li>Content management systems</li><li>Learning management systems</li></ul><p><strong>Electronic content and software authoring tools and platforms</strong></p><ul><li>Microsoft Office</li><li>Adobe Acrobat Professional</li><li>Adobe InDesign</li><li>PDF Generators and Converters</li><li>Graphing and Charting Programs</li></ul><p><strong>Software infrastructure</strong></p><ul><li>Operating Systems</li><li>Browsers</li><li>Systems/network administration software</li><li>Collaboration environments</li><li>Remote access software</li><li>User Authentication Software</li><li>Virtual meeting tools (e.g., VOIP, screen shares, remote meetings)</li><li>Cloud Services & Administrative/Reporting Interfaces</li></ul><p /><button onclick="window.close()">Go Back</button>';
...
function DARTFAQS()
{
    ...
    detailsWindow.document.write(DARTFAQSHTML);
    detailsWindow.focus();
    detailsWindow.document.documentElement.setAttribute('lang','en');
        ...
        if($("input[name='ictexceptionsradiobuttonsfor"+str+"']:checked").val() === "NEA") // ELECTRONIC CONTENT VALIDATION
        {
          ...
          if($("input[name='ElectronicContentList-"+str+"']:checked"))
          {
            ...
            else
            {
                ElectronicContentCount = 0;
                currentlocation = str;
                // skip brand name question in Electronic Content section throughout all DART workflows
        ...
        if(!$("input[name='SoftwareList-"+str+"']:checked").val()) // SOFTWARE VALIDATION
         ...
         if($("input[name='SoftwareList-"+str+"']:checked").val() !== "none")
         {
          ...
          if($("input[name='SoftwareCriteria-"+str+"']:checked").val() == "none" || $("input[name='SoftwareCriteria-"+str+"']:checked").val() == "I do not know")
          {
            ...
            // skip this brand name question throughout all DART workflows
            if(currentselection != "requirements" && currentselection != "RFI" && currentselection != "solication")
            {
...
// =================================
        ...
        else // if anything else other than none has been checked
        {
          if($("input[name='HardwareList-"+str+"']:checked").val() != "none")
          {
            ...
            {
              // skip brand new question throughout all DART workflows
              if(currentselection != "requirements" && currentselection != "RFI" && currentselection != "solication")
              {
...
function goHome()
{
  ...
  document.getElementById("body").innerHTML = '<div class="dart"></div><div class="row">  <div class="column" style="border-right: 5px solid white;"><h2 style="padding-bottom:10px; background-color: #02356a;color: white;text-align: center;padding: 5px; margin-top: 0px;">What to Expect</h2><ul><li>DART will ask you a few simple questions about what IT products and services you are buying or building. No knowledge of Section 508 or accessibility is required.</li><li>After you answer the questions, DART will determine how the Section 508 standards apply to the activity you are performing, and provide you with tailored language along with instructions.</li><li>On the output page, DART will provide you the option to copy the language or export it to a Microsoft Word document.</li></ul></div>     <div class="column" style=""> <h2 style="padding-bottom:10px; background-color: #02356a;color: white;text-align: center;padding: 5px; margin-top: 0px;">Resources</h2><ul><li><a href="javascript:UpdateLog()">What’s New in DART 2.1?</a></li><li><a href="http://section508testing.org/playbook/resources/dart-guide/DART%202.1%20Orientation%20Guide.pptm">DART 2.1 User Guide</a></li><li><a href="javascript:Requirements508Info()">When do I need to include Section 508 requirements in my solicitation?</a></li><li><a href="javascript:ICTSolicationsExample()">What is information and communications technology (ICT)?</a></li><li><a href="http://section508testing.org/playbook/resources/dart-guide/" target="_blank">Section 508 Solicitation Language Overview</a></li><li><a href="javascript:DARTFAQS()">Frequently Asked Questions</a></li><li><a href="http://section508testing.org/DART20" target="_blank">DART 2.0 (old version - link available until 10/1/2020)</a></li></ul></div>     <div class="column" style="border-left: 5px solid white;">    <h2 style="padding-bottom:10px; background-color: #02356a;color: white;text-align: center;padding: 5px; margin-top: 0px;">Get Help</h2><div id="gethelp"><p><strong>For help using DART</strong><br />Accessibility Help Desk:<br />202-447-0440 (voice)<br />202-447-0582 (fax)<br /><a href="mailto:accessibility@hq.dhs.gov">accessibility@hq.dhs.gov</a><p><strong>For help understanding the Section 508 requirements or with preparing for ITAR Reviews</strong><br />contact your <a href="https://www.section508.gov/tools/coordinator-listing#usdhs" target="_blank"><u>Component Section 508 Program Manager</p></u></a></p></div></div></div><hr>';
  document.getElementById("body").innerHTML += '<div class="dart"> <fieldset> <legend><h1>How can DART help you?</h1></legend>Click one of the options below and then click the [START] button.<section> <div class="radio-wrapper"> <input type="radio" id="control_01" name="select" value="requirements"> <label for="control_01"> <h2>Project Planning</h2> <p>I want to identify the applicable Section 508 standards I need to address during project planning.</p> </label></div><div class="radio-wrapper"> <input type="radio" id="control_03" name="select" value="RFI"> <label for="control_03"> <h2>Market Research</h2> <p>I want to obtain product documentation and/or capability statements to determine the availability of accessible products and services using a Request for Information (RFI).</p> </label></div><div class="radio-wrapper"> <input type="radio" id="control_05" name="select" value="solication"> <label for="control_05"> <h2>Solicitation Development</h2> <p>I want to obtain Section 508 requirements to include in my statement of work.</p> </label></div></section> <div class="startButton"><button onclick="startDART()">Start</button></fieldset></div> ';
  ...
  // document.getElementById("body").innerHTML += '<div class="dart"><h1>How can DART help you?</h1><section><div><input type="radio" id="control_01" name="select" value="requirements"><label for="control_01"><h2>Section 508 Solicitation Requirements</h2><p>I want to identify what Section 508 requirements I need to address in my project or acquisition plan.</p></label></div><div><input type="radio" id="control_02" name="select" value="marketresearch"><label for="control_02"><h2>Market Research</h2><p>I want help getting Section 508 information to conduct market research.</p></label></div><div><input type="radio" id="control_03" name="select" value="RFI"><label for="control_03"><h2>Request for Information (RFI)</h2><p>I want sample Section 508 language to include in my request for information (RFI)</p></label></div><div><input type="radio" id="control_05" name="select" value="solication" checked><label for="control_05"><h2>Generate Section 508 Solication Language</h2><p>I want to get Section 508 language to include in my solication.</p></label></div></section><div class="startButton"><button onclick="startDART()">Start</button></div>';
  // document.getElementById("body").innerHTML += '<div class="dart"><h1>Welcome to the updated DHS Accessibility Requirements Tool (DART 2.1).</h1><p><strong>What to Expect:</strong></p><p><ul><li>You will answer a few simple questions about what IT products and services you are buying or building.</li><li>The tool will determine what 508 standards apply to each IT product and service you are buying based on your answers.</li><li>After completing the questions, DART will provide tailored 508 language to include in your solicitation, along with instructions on next steps.</li></ul><p><strong>Good to know:</strong><br /><a href="javascript:DARTUserGuide()">User Guide</a><br /><a href="javascript:ICTSolicationsExample()">What is information and communications technology (ICT)?</a><br /><a href="javascript:DARTFAQS()">Frequently Asked Questions</a></p><h1>How can DART help you?</h1><section><div><input type="radio" id="control_01" name="select" value="1" checked><label for="control_01"><h2>Section 508 Solicitation Requirements</h2><p>I want to identify what Section 508 requirements I need to address in my project or acquisition plan.</p></label></div><div><input type="radio" id="control_02" name="select" value="2"><label for="control_02"><h2>Market Research</h2><p>I want help getting Section 508 information to conduct market research.</p></label></div><div><input type="radio" id="control_03" name="select" value="3"><label for="control_03"><h2>Request for Information (RFI)</h2><p>I want sample Section 508 language to include in my request for information (RFI)</p></label></div><div><input type="radio" id="control_05" name="select" value="5"><label for="control_05"><h2>Generate Section 508 Solication Language</h2><p>I want to get Section 508 language to include in my solication.</p></label></div></section><div class="startButton"><button onclick="startDART()">Start</button></div><h1>Where can I get help?</h1>Accessibility Help Desk:<br />202-447-0440 (voice)<br />202-447-0582 (fax)<br /><a href="mailto:accessibility@hq.dhs.gov">accessibility@hq.dhs.gov</a></div>';
  // document.getElementById("body").innerHTML += '<div id="bodyfirstpage">';
    // document.getElementById("body").innerHTML += '<div class="row">  <div class="column" style="border-right: 5px solid white;">  <h2 style="padding-bottom:10px; background-color: #02356a;color: white;text-align: center;padding: 5px; margin-top: 0px;">What to Expect</h2><p>Welcome to the updated DHS Accessibility Requirements Tool (DART 2.1).</p><p><strong>What to Expect:</strong></p><p><ul><li>You will answer a few simple questions about what IT products and services you are buying or building.</li><li>The tool will determine what 508 standards apply to each IT product and service you are buying based on your answers.</li><li>After completing the questions, DART will provide tailored 508 language to include in your solicitation, along with instructions on next steps.</li></ul></p> <div class="centerButton"><button onclick="DARTUserGuide()">User Guide</button></div><p><strong>Where can I get help?</strong></p><p>Accessibility Help Desk:<br /> 202-447-0440 (voice)<br /> 202-447-0582 (fax)<br /> <a href="mailto:accessibility@hq.dhs.gov">accessibility@hq.dhs.gov</a></p></div>     <div class="column" style="">    <h2 style="padding-bottom:10px; background-color: #02356a;color: white;text-align: center;padding: 5px; margin-top: 0px;">Market Research</h2><p>Use this job aid during project planning and market research:</p><ul><li>Identify what Section 508 requirements may apply to your project&rsquo;s technology deliverables.</li><li>Guidelines on how to obtain Section 508 documentation from potential vendors and contractors.</li><li>Sample Section 508 language to include in a Request for Information (RFI).</li></ul><div class="centerButton"><button onclick="startQuestionnareMarketResearch()">Start Questionnaire for Market Research</button></div> </div>     <div class="column" style="border-left: 5px solid white;">    <h2 style="padding-bottom:10px; background-color: #02356a;color: white;text-align: center;padding: 5px; margin-top: 0px;">Obtain Section 508 Solicitation Language</h2><p>Use this job aid when preparing solicitations for technology products and services. <strong>Section 508 solicitation language</strong> is required when purchasing <a href="javascript:ICTSolicationsExample()">information and communications technology (ICT)</a>. &nbsp;</p><p>Common situations include:</p><ul><li>New Solicitations</li><li>Task Orders under existing contracts (including contracts managed by other agencies)</li><li>ICT that will be provided to the public &amp; internally</li><li>ICT COTS/GOTS licenses</li><li>ICT approved on the TRM</li><li>ICT proof of concepts, pilot efforts, and MVPs</li><li>ICT provided as a service (example &ndash; SaaS, PaaS)</li><li>ICT provided through open source arrangements</li><li>ICT that  has an authorized 508 exception</li><li>Services to develop, modify, configure, install, maintain, and host ICT</li><li>Services that produce ICT in support of other deliverables (ex.&nbsp; Electronic forms)&nbsp;</li></ul></p><p><a href="javascript:DARTFAQS()">Frequently Asked Questions</a></p> <div class="centerButton"><button onclick="startQuestionnareSolication()">Start Questionnaire for Solication</button></div></div>';
...
detailsWindow.document.close();
   ...
   {
       var DisclaimerHTML = '<style>#disclaimer{font-family: sans-serif; color:white; font-size: 24px; text-align: center; font-weight: bold; background-color: red; padding: 5px; -webkit-touch-callout: none; -webkit-user-select: none; -khtml-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; margin-bottom: 10px;}</style><div id="disclaimer">Not approved for use in solicitation language</div>';
     if (confirm("This list of applicable 508 standards is only provided to assist with project planning, market research, and alternatives analysis.  By selecting ok, you acknowledge that this language will not be used for solicitation purposes.")) {
      ...
      OutputHTML += "</div>";
      // OutputHTML += "<hr>";
      // OutputHTML += "<p /><h1>Recommended language for inclusion in a Request for Information:</h1><p /><h2><strong>Section 508 Requirements</strong></h2><p>DHS has determined that the following Section 508 standards may apply to the following ICT items:</p>";
      // generateRequirements1();
  ...
  function write508RFI()
   {
     ...
     if (confirm("This recommended output is solely for use in a Request for Information. By selecting OK, you acknowledge that this language will not be used for solicitation purposes.")) {
      ...
      // generateRequirements1();
      // OutputHTML += "<hr>";
      // OutputHTML += "<div id='ABC123'><p /><h1 id='noselect'>Recommended language for inclusion in a Request for Information:</h1><p /><h2><strong>Section 508 Requirements</strong></h2><p>DHS has determined that the following Section 508 standards may apply to the following ICT items:</p>";
   ...
   function generateContractHTML()
   {
      ...
      for(i = 0; i < unique_array.length; i++)
      {
       ...
       if(exceptiontoallICT == true)
       {
        ...
        OutputHTML += '<li>Exceptions for this work statement have been determined by DHS and only the exceptions described herein may be applied. Any request for additional exceptions shall be sent to the Contracting Officer and a determination will be made according to DHS Directive 139-05, Office of Accessible Systems and Technology, dated November 12, 2018 and DHS Instruction 139-05-001, Managing the Accessible Systems and Technology Program, dated November 20, 2018, or any successor document.</li>';
       }
       ...
       /// NEW 508 REQUIREMENTS FOR TECHNOLOGY SERVICES PER APRIL 24 2020 FOR DART 2.1
      ...
      if(document.getElementById("step3q6-0").checked) // Developing or modifying web
      {
        ...
        OutputHTML += '<li>When developing or modifying web based and electronic content components, except for electronic documents and non-fillable forms provided in a Microsoft Office or Adobe PDF format, the Contractor shall demonstrate conformance to the applicable Section 508 standards (including WCAG 2.0 Level A and AA Success Criteria) by conducting testing using the DHS Trusted Tester for Web Methodology Version 5.0 or successor versions, and shall ensure testing is conducted by individuals who are certified by DHS on version 5.0 or successor versions (e.g. &ldquo;DHS Certified Trusted Testers&rdquo;). The Contractor shall provide the Trusted Tester Certification IDs to DHS upon request.&nbsp;&nbsp; Information on the DHS Trusted Tester for Web Methodology Version 5.0, related test tools, test reporting, training, and tester certification requirements is published at <a href="https://www.dhs.gov/trusted-tester">https://www.dhs.gov/trusted-tester</a>.</li>';
      }
      ...
      OutputHTML += "</ol></div>";
       ...
       /* ------- APRIL 24 2020 THIS HAS BEEN COMMENTED OUT PER DART 2.1 REQUIREMENTS TO INSERT NEW 508 REQUIREMENTS FOR TECHNOLOGY SERVICES ----- I'M SAVING THIS IN CASE IF I NEED TO REVERSE BACK TO ORIGINAL REQUIREMENTS ----
       if(document.getElementById("step3q6-5").checked) // hosting
         ...
         {
            OutputHTML += '<li>When developing or modifying web based and electronic content components, except for electronic documents and non-fillable forms provided in a Microsoft Office or Adobe PDF format, the Contractor shall demonstrate conformance to the applicable Section 508 standards (including WCAG 2.0 Level A and AA Success Criteria) by conducting testing using the DHS Trusted Tester for Web Methodology Version 5.0 or successor versions, and shall ensure testing is conducted by individuals who are certified by DHS on version 5.0 or successor versions (e.g. &ldquo;DHS Certified Trusted Testers&rdquo;). The Contractor shall provide the Trusted Tester Certification IDs to DHS upon request.&nbsp;&nbsp; Information on the DHS Trusted Tester for Web Methodology Version 5.0, related test tools, test reporting, training, and tester certification requirements is published at <a href="https://www.dhs.gov/trusted-tester">https://www.dhs.gov/trusted-tester</a>.</li>';
            OutputHTML += '<li>When developing or modifying software functions of ICT, the Contractor shall demonstrate conformance to the applicable Section 508 standards (including the requirements in Chapter 5 and WCAG 2.0 Level A and AA Success Criteria).&nbsp; When the requirements in Chapter 5 do not address one or more software functions, the Contractor shall demonstrate conformance to the Functional Performance Criteria specified in Chapter 3.&nbsp;<ul><li>The Contractor shall use a test process capable of validating conformance to all applicable Section 508 standards for software functionality delivered pursuant to this contract.</li><li>The Contractor may utilize the DHS Trusted Tester Methodology for Web and Software Version 4.0 as a component of the overall test process used. This version of the test process provides partial test coverage of the Section 508 standards that apply to software.&nbsp; If the Contractor uses this test process, the Contractor shall be required to address the coverage gaps through additional test procedures.&nbsp;&nbsp; Information on the DHS Trusted Tester Methodology for Web and Software Version 4.0, including coverage against the applicable Section 508 standards for software, related test tools, and training is published at <a href="https://www.dhs.gov/trusted-tester">https://www.dhs.gov/trusted-tester</a>.&nbsp;&nbsp;</li><li>The Contractor shall report on the level of conformance achieved with the applicable Section 508 standards using an Accessibility Conformance Report (ACR) based on the Voluntary Product Accessibility Template Version 2.0 508 (or later). The Voluntary Product Accessibility Template is published at <a href="https://www.itic.org/policy/accessibility/vpat">https://www.itic.org/policy/accessibility/vpat</a>.&nbsp;</li></ul></li>';
         }
         if(document.getElementById("step3q6-1").checked) // Developing or modifying electronic documents and forms provided in a Microsoft Office or Adobe PDF format
         {
...
*/ 
/* OLD DART 2.0 INSTRUCTIONS TO OFFERORS AND ACCEPTANCE CRITERIA STARTS HERE --- SAVING THIS IN CASE IF I NEED TO RE-ENABLE IT
         //------------------------------------------------------
    ...
    // end of old DART 2.0 Instructions to Offerors and Acceptance Criteria 
    OutputHTML += '<script> function SelectAllandCopy(){ var x = document.getElementById("ABC123").innerText;  var range = document.createRange(); range.selectNode(document.getElementById("ABC123"));   window.getSelection().addRange(range);    document.execCommand("copy");     alert("text copied, go ahead and paste!") }  <\/script>';
              //print instructions only
      OutputHTML += '<script> function printDiv(divName) {     var printContents = document.getElementById(divName).innerHTML;     var originalContents = document.body.innerHTML;     document.body.innerHTML = printContents;     window.print();     document.body.innerHTML = originalContents;}  <\/script>';
        //export to doc 
...
gtag('js', new Date());
gtag('config', 'UA-32318423-1');

(window.BOOMR_mq=window.BOOMR_mq||[]).push(["addVar",{"rua.upush":"false","rua.cpush":"false","rua.upre":"false","rua.cpre":"false","rua.uprl":"false","rua.cprl":"false","rua.cprf":"false","rua.trans":"SJ-5b1a59d0-57a7-4d26-9117-fdd427344c3e","rua.cook":"false","rua.ims":"false","rua.ufprl":"false","rua.cfprl":"false","rua.isuxp":"","rua.texp":""}]);

!function(a){var e="https://s.go-mpulse.net/boomerang/",t="addEventListener";if("False"=="True")a.BOOMR_config=a.BOOMR_config||{},a.BOOMR_config.PageParams=a.BOOMR_config.PageParams||{},a.BOOMR_config.PageParams.pci=!0,e="https://s2.go-mpulse.net/boomerang/";if(window.BOOMR_API_key="A3WTK-PERZP-2W77L-XJ2AR-542NX",function(){function n(e){a.BOOMR_onload=e&&e.timeStamp||(new Date).getTime()}if(!a.BOOMR||!a.BOOMR.version&&!a.BOOMR.snippetExecuted){a.BOOMR=a.BOOMR||{},a.BOOMR.snippetExecuted=!0;var i,_,o,r=document.createElement("iframe");if(a[t])a[t]("load",n,!1);else if(a.attachEvent)a.attachEvent("onload",n);r.src="javascript:void(0)",r.title="",r.role="presentation",(r.frameElement||r).style.cssText="width:0;height:0;border:0;display:none;",o=document.getElementsByTagName("script")[0],o.parentNode.insertBefore(r,o);try{_=r.contentWindow.document}catch(O){i=document.domain,r.src="javascript:var d=document.open();d.domain='"+i+"';void(0);",_=r.contentWindow.document}_.open()._l=function(){var a=this.createElement("script");if(i)this.domain=i;a.id="boomr-if-as",a.src=e+"A3WTK-PERZP-2W77L-XJ2AR-542NX",BOOMR_lstart=(new Date).getTime(),this.body.appendChild(a)},_.write("<bo"+'dy onload="document._l();">'),_.close()}}(),"".length>0)if(a&&"performance"in a&&a.performance&&"function"==typeof a.performance.setResourceTimingBufferSize)a.performance.setResourceTimingBufferSize();!function(){if(BOOMR=a.BOOMR||{},BOOMR.plugins=BOOMR.plugins||{},!BOOMR.plugins.AK){var e="false"=="true"?1:0,t="",n="jbjqvqtip7tv2yd5zqpq-f-ced84b58a-clientnsv4-s.akamaihd.net",i={"ak.v":"31","ak.cp":"26930","ak.ai":parseInt("102510",10),"ak.ol":"0","ak.cr":9,"ak.ipv":4,"ak.proto":"h2","ak.rid":"1033c0a6","ak.r":37295,"ak.a2":e,"ak.m":"dsca","ak.n":"essl","ak.bpcip":"72.83.10.0","ak.cport":53044,"ak.gh":"23.40.190.178","ak.quicv":"","ak.tlsv":"tls1.3","ak.0rtt":"","ak.csrc":"-","ak.acc":"","ak.t":"1618856991","ak.ak":"hOBiQwZUYzCg5VSAfCLimQ==","ak.pv":"395","ak.dpoabenc":""};if(""!==t)i["ak.ruds"]=t;var _={i:!1,av:function(e){var t="http.initiator";if(e&&(!e[t]||"spa_hard"===e[t]))i["ak.feo"]=void 0!==a.aFeoApplied?1:0,BOOMR.addVar(i)},rv:function(){var a=["ak.bpcip","ak.cport","ak.cr","ak.csrc","ak.gh","ak.ipv","ak.m","ak.n","ak.ol","ak.proto","ak.quicv","ak.tlsv","ak.0rtt","ak.r","ak.acc","ak.t"];BOOMR.removeVar(a)}};BOOMR.plugins.AK={akVars:i,akDNSPreFetchDomain:n,init:function(){if(!_.i){var a=BOOMR.subscribe;a("before_beacon",_.av,null,null),a("onbeacon",_.rv,null,null),_.i=!0}return this},is_complete:function(){return!0}}}}()}(window);
