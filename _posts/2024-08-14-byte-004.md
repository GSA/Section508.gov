...
<div class="summary-box--code">
    &lt;a href="annual-report.pdf">Download the annual report&lt;/a>
</div>

#### Example 2: Contextual Clarity
<div class="summary-box--code">
    &lt;a href="accessibility-policy.html">Learn more about our accessibility policy&lt;/a>
</div>

#### Example 3: Avoiding URLs as Link Text
<div class="summary-box--code">
    &lt;a href="https://www.example.gov/accessibility-guidelines">View our accessibility guidelines&lt;/a>
</div>
...
<div class="tablet:grid-col" style="margin: auto; max-width: 100%; text-align: center; padding: 10px 0px">
    <div class="margin-top-1"><img src="{{site.baseurl}}/assets/images/byte-004-figure-1.jpg" alt="Document containing sample text with 'Section508.gov' highlighted (Step 1), and arrows pointing to the Links ribbon menu (Step 2), and Link context menus (Step 3)." aria-describedby="figure-1" class="padding-1">
    </div>
    <div class="font-mono-3xs margin-x-auto auto" style="max-width: 90%; text-align: center;"><span id="figure-1"><strong>Figure 1.</strong> Steps 1 to 3 to open the Insert Hyperlink dialog box.</span>
    </div>
</div>
...
*   **Programmatically Inspect:** For websites, use tools like [ANDI]({{site.baseurl}}/tools/tools-for-testing-ict/) and browser-based developer inspection tools to ensure link text is read correctly for screen readers.
...
* <a href="{{site.baseurl}}/tools/tools-for-testing-ict/" target="_blank" class="usa-link--external">Accessible Name & Description Inspector) | SSA</a>
