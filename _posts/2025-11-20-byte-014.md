...
<div class="tablet:grid-col" style="margin: auto; max-width: 100%; text-align: center; padding: 10px 0px">
   ...
   <div class="font-mono-3xs margin-x-auto auto" style="max-width: 90%; text-align: center;"><span id="figure-5"><strong>Figure 5:</strong> Microsoft PowerPoint presentation in Outline View, showing a hidden Title.</span>
   </div>
</div>
...
<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  <strong>TIP:</strong> For best results, <a href="https://www.section508.gov/~assets/files/accessibility-bytes-14-unqiue-presentation-titles.pptx" target="_blank" class="usa-link--external">download and view</a> this Microsoft PowerPoint presentation on your computer.
</div>
