...
<div class="grid-col-12 border-base radius-lg padding-1" style="border: 1px solid black; background-color: #f5f9fc;">
  <strong>TIP:</strong> For best results, <a href="https://www.section508.gov/~assets/files/accessibility-bytes-14-unique-presentation-titles.pptx" target="_blank" class="usa-link--external">download and view</a> this Microsoft PowerPoint presentation on your computer.
</div>
