...
<ul class="usa-icon-list tablet:grid-col">
  <li class="usa-icon-list__item">
      ...
      <div class="usa-icon-list__content">Read the <a href="{{site.baseurl}}/manage/playbooks/technology-accessibility-playbook/">Technology Accessibility Playbook</a></div>
  </li>
</ul>
